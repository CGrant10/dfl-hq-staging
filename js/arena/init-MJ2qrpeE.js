import { B as e, H as t, R as n, T as r, at as i, d as a, f as o, i as s, l as c, m as l, ot as u, t as d, tt as f, u as p } from "./Geometry-D1neCpWU.js";
import { t as m } from "./getPo2TextureFromSource-Drp0bisT.js";
import { t as h } from "./canvasUtils-DlqG_Aub.js";
import { t as g } from "./CanvasPool-DlfXgyy9.js";
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/bounds/getRenderableBounds.mjs
var _ = new f();
function v(e, t) {
	t.clear();
	let n = t.matrix;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/filters/CanvasFilterSystem.mjs
function y(e) {
	return typeof e.getCanvasFilterString == "function";
}
var b = class {
	constructor() {
		this.skip = !1, this.useClip = !1, this.filters = null, this.container = null, this.bounds = new e(), this.cssFilterString = "";
	}
}, x = class {
	constructor(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/filters/defaults/defaultFilter.vert.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/filters/FilterSystem.mjs
var D = new d({
	...
	constructor() {
		this.skip = !1, this.inputTexture = null, this.backTexture = null, this.filters = null, this.bounds = new e(), this.container = null, this.blendRequired = !1, this.outputRenderSurface = null, this.globalFrame = {
			x: 0,
			y: 0,
			width: 0,
			height: 0
	...
	constructor(e) {
		...
		}), this._globalFilterBindGroup = new p({}), this.renderer = e;
	}
	...
	generateFilteredTexture({ texture: e, filters: n }) {
		let i = this._pushFilterData();
		this._activeFilterData = i, i.skip = !1, i.filters = n;
		let a = e.source, o = a.resolution, s = a.antialias;
		if (n.every((e) => !e.enabled)) return i.skip = !0, e;
		let c = i.bounds;
		if (c.addRect(e.frame), this._calculateFilterBounds(i, c.rectangle, s, o, 0), i.skip) return e;
		let l = o;
		this._calculateGlobalFrame(i, 0, 0, l, a.width, a.height), i.outputRenderSurface = r.getOptimalTexture(c.width, c.height, i.resolution, i.antialias), i.backTexture = t.EMPTY, i.inputTexture = e, this.renderer.renderTarget.finishRenderPass(), this._applyFiltersToTexture(i, !0);
		let u = i.outputRenderSurface;
		return u.source.alphaMode = "premultiplied-alpha", u;
	}
	pop() {
		let e = this.renderer, t = this._popFilterData();
		t.skip || (e.globalUniforms.pop(), e.renderTarget.finishRenderPass(), this._activeFilterData = t, this._applyFiltersToTexture(t, !1), t.blendRequired && r.returnTexture(t.backTexture), r.returnTexture(t.inputTexture));
	}
	getBackTexture(e, t, n) {
		let i = e.colorTexture.source._resolution, a = r.getOptimalTexture(t.width, t.height, i, !1), o = t.minX, s = t.minY;
		n && (o -= n.minX, s -= n.minY), o = Math.floor(o * i), s = Math.floor(s * i);
	...
	calculateSpriteMatrix(e, t) {
		let n = this._activeFilterData, r = e.set(n.inputTexture._source.width, 0, 0, n.inputTexture._source.height, n.bounds.minX, n.bounds.minY), i = t.worldTransform.copyTo(f.shared), a = t.renderGroup || t.parentRenderGroup;
	...
	_setupFilterTextures(e, n, i, a) {
		if (e.backTexture = t.EMPTY, e.inputTexture = r.getOptimalTexture(n.width, n.height, e.resolution, e.antialias), e.blendRequired) {
			i.renderTarget.finishRenderPass();
			let t = i.renderTarget.getRenderTarget(e.outputRenderSurface);
			e.backTexture = this.getBackTexture(t, n, a?.bounds);
		}
		i.renderTarget.bind({
			target: e.inputTexture,
			clear: !0
		}), i.globalUniforms.push({ offset: n });
	}
	...
	_updateFilterUniforms(e, n, r, i, a, o, s, c) {
		...
		this.renderer.renderTarget.bind({
			target: n,
			clear: !!c
		}), n instanceof t ? (h[0] = n.frame.width, h[1] = n.frame.height) : (h[0] = _.width, h[1] = _.height), h[2] = _.isRoot ? -1 : 1, this._filterGlobalUniforms.update();
	}
	...
	_applyFiltersToTexture(e, t) {
		let n = e.inputTexture, i = e.bounds, a = e.filters, o = e.firstEnabledIndex, s = e.lastEnabledIndex;
		if (this._globalFilterBindGroup.setResource(n.source.style, 2), this._globalFilterBindGroup.setResource(e.backTexture.source, 3), o === s) a[o].apply(this, n, e.outputRenderSurface, t);
		else {
			let n = e.inputTexture, c = r.getOptimalTexture(i.width, i.height, n.source._resolution, !1), l = c;
			for (let e = o; e < s; e++) {
				let t = a[e];
			...
			a[s].apply(this, n, e.outputRenderSurface, t), r.returnTexture(c);
		}
	}
...
//# sourceMappingURL=init-MJ2qrpeE.js.map