...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/utils/logging/deprecation.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/utils/misc/NOOP.mjs
var le = () => {};
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/maths/misc/pow2.mjs
function ue(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/utils/definedProps.mjs
function fe(e) {
	let t = {};
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/shared/texture/TextureStyle.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/shared/texture/TextureMatrix.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/utils/data/updateQuadBounds.mjs
function xe(e, t, n) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/bounds/Bounds.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/color/Color.mjs
Ge([Ke]);
var H = class e {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/utils/pool/GlobalResourceRegistry.mjs
var Ze = {
	...
	getPool(e) {
		return this._poolsByClass.has(e) || this._poolsByClass.set(e, new Qe(e)), this._poolsByClass.get(e);
	}
	stats() {
		let e = {};
...
Ze.register(W);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/container-mixins/cacheAsTextureMixin.mjs
var $e = {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/utils/data/removeItems.mjs
function et(e, t, n) {
	let r = e.length, i;
	if (t >= r || n === 0) return;
	n = t + n > r ? r - t : n;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/container-mixins/childrenHelperMixin.mjs
var tt = {
	allowChildren: !0,
	...
	addChildAt(e, t) {
		...
		return this.sortableChildren && (this.sortDirty = !0), r ? (i && (i.structureDidChange = !0), e) : (e.parent = this, e.didChange = !0, e._updateFlags = 15, i && i.addChild(e), this.emit("childAdded", e, this, t), e.emit("added", this), e);
	},
	swapChildren(e, t) {
		if (e === t) return;
	...
	getMaskEffect(e) {
		...
		for (let t = 0; t < this._tests.length; t++) {
			let n = this._tests[t];
			if (n.test(e)) return W.get(n.maskClass, e);
		}
		return e;
	}
	returnMaskEffect(e) {
...
p.handleByList(u.MaskEffect, it._effectClasses);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/container-mixins/effectsMixin.mjs
var at = {
	_maskEffect: null,
	_maskOptions: {
		inverse: !1,
	...
	set filters(e) {
		...
		let t = this._filterEffect ||= new rt();
		e = e;
	...
	set filterArea(e) {
		this._filterEffect ||= new rt(), this._filterEffect.filterArea = e;
	},
	get filterArea() {
...
}, G = W.getPool(x), K = W.getPool(F), st = new x(), ct = {
	...
	_getGlobalBoundsRecursive(e, t, n) {
		...
		if ((this.renderGroup || i) && (r = K.get().clear()), this.boundsArea) t.addRect(this.boundsArea, this.worldTransform);
		else {
		...
		if (i) {
			...
			e && r.applyMatrix(n.worldTransform.copyTo(st).invert()), t.addBounds(r), K.return(r);
		} else this.renderGroup && (t.addBounds(r, this.relativeGroupTransform), K.return(r));
	}
};
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/bounds/getGlobalBounds.mjs
function lt(e, t, n) {
	n.clear();
	let r, i;
	return e.parent ? t ? r = e.parent.worldTransform : (i = G.get().identity(), r = dt(e, i)) : r = x.IDENTITY, ut(e, n, r, t), i && G.return(i), n.isValid || n.set(0, 0, 0, 0), n;
}
function ut(e, t, n, r) {
	if (!e.visible || !e.measurable) return;
	let i;
	r ? i = e.worldTransform : (e.updateLocalTransform(), i = G.get(), i.appendFrom(e.localTransform, n));
	let a = t, o = !!e.effects.length;
	if (o && (t = K.get().clear()), e.boundsArea) t.addRect(e.boundsArea, i);
	else {
		let n = e.bounds;
		n && !n.isEmpty() && (t.matrix = i, t.addBounds(n));
		for (let n = 0; n < e.children.length; n++) ut(e.children[n], t, i, r);
	}
	if (o) {
		for (let n = 0; n < e.effects.length; n++) e.effects[n].addBounds?.(t);
		a.addBounds(t, x.IDENTITY), K.return(t);
	}
	r || G.return(i);
}
function dt(e, t) {
	let n = e.parent;
	return n && (dt(n, t), n.updateLocalTransform(), t.append(n.localTransform)), t;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/utils/multiplyHexColors.mjs
function ft(e, t) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/utils/multiplyColors.mjs
var pt = 16777215;
function mt(e, t) {
	return e === pt ? t : t === pt ? e : ft(e, t);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/container-mixins/getGlobalMixin.mjs
function q(e) {
...
var ht = {
	...
	getGlobalTransform(e = new x(), t) {
		...
		let n = dt(this, G.get().identity());
		return e.appendFrom(this.localTransform, n), G.return(n), e;
	},
	getGlobalTint(e) {
		if (e) return this.renderGroup ? q(this.renderGroup.worldColor) : this.parentRenderGroup ? q(mt(this.localColor, this.parentRenderGroup.worldColor)) : this.tint;
		let t = this.localColor, n = this.parent;
		for (; n;) t = mt(t, n.localColor), n = n.parent;
		return q(t);
	}
};
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/bounds/getLocalBounds.mjs
function gt(e, t, n) {
	return t.clear(), n ||= x.IDENTITY, _t(e, t, n, e, !0), t.isValid || t.set(0, 0, 0, 0), t;
}
function _t(e, t, n, r, i) {
	let a;
	if (i) a = G.get(), a = n.copyTo(a);
	else {
		if (!e.visible || !e.measurable) return;
		e.updateLocalTransform();
		let t = e.localTransform;
		a = G.get(), a.appendFrom(t, n);
	}
	let o = t, s = !!e.effects.length;
	if (s && (t = K.get().clear()), e.boundsArea) t.addRect(e.boundsArea, a);
	else {
		e.renderPipeId && (t.matrix = a, t.addBounds(e.bounds));
		let n = e.children;
		for (let e = 0; e < n.length; e++) _t(n[e], t, a, r, !1);
	}
	if (s) {
		for (let n = 0; n < e.effects.length; n++) e.effects[n].addLocalBounds?.(t, r);
		o.addBounds(t, x.IDENTITY), K.return(t);
	}
	G.return(a);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/utils/checkChildrenDidChange.mjs
function vt(e, t) {
	let n = e.children;
	for (let e = 0; e < n.length; e++) {
		let r = n[e], i = r.uid, a = (r._didViewChangeTick & 65535) << 16 | r._didContainerChangeTick & 65535, o = t.index;
		(t.data[o] !== i || t.data[o + 1] !== a) && (t.data[t.index] = i, t.data[t.index + 1] = a, t.didChange = !0), t.index = o + 2, r.children.length && vt(r, t);
	}
	return t.didChange;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/container-mixins/measureMixin.mjs
var yt = new x(), bt = {
	...
	getLocalBounds() {
		...
		return e.index = 1, e.didChange = !1, e.data[0] !== this._didViewChangeTick && (e.didChange = !0, e.data[0] = this._didViewChangeTick), vt(this, e), e.didChange && gt(this, e.localBounds, yt), e.localBounds;
	},
	getBounds(e, t) {
		return lt(this, e, t || new F());
	}
}, xt = {
	_onRender: null,
	set onRender(e) {
	...
	sortChildren() {
		this.sortDirty && (this.sortDirty = !1, this.children.sort(Ct));
	}
};
function Ct(e, t) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/container-mixins/toLocalGlobalMixin.mjs
var wt = {
	...
	toGlobal(e, t, n = !1) {
		let r = this.getGlobalTransform(G.get(), n);
		return t = r.apply(e, t), G.return(r), t;
	},
	toLocal(e, t, n, r) {
		t && (e = t.toGlobal(e, n, r));
		let i = this.getGlobalTransform(G.get(), r);
		return n = i.applyInverse(e, n), G.return(i), n;
	}
}, Tt = class {
	constructor() {
...
Ze.register(Dt);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/RenderGroup.mjs
var Ot = class {
	constructor() {
		this.renderPipeId = "renderGroup", this.root = null, this.canBundle = !1, this.renderGroupParent = null, this.renderGroupChildren = [], this.worldTransform = new x(), this.worldColorAlpha = 4294967295, this.worldColor = 16777215, this.worldAlpha = 1, this.childrenToUpdate = /* @__PURE__ */ Object.create(null), this.updateTick = 0, this.gcTick = 0, this.childrenRenderablesToUpdate = {
			list: [],
			index: 0
		}, this.structureDidChange = !0, this.instructionSet = new Tt(), this._onRenderContainers = [], this.textureNeedsUpdate = !0, this.isCachedAsTexture = !1, this._matrixDirty = 7;
	}
	init(e) {
	...
	disableCacheAsTexture() {
		this.isCachedAsTexture = !1, this.texture &&= (Dt.returnTexture(this.texture, !0), null);
	}
	updateCacheTexture() {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/utils/assignWithIgnore.mjs
function kt(e, t, n = {}) {
	for (let r in t) !n[r] && t[r] !== void 0 && (e[r] = t[r]);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/container/Container.mjs
var At = new m(null), J = new m(null), jt = new m(null, 1, 1), Mt = new m(null), Nt = class e extends h {
	constructor(e = {}) {
		super(), this.uid = k("renderable"), this._updateFlags = 15, this.renderGroup = null, this.parentRenderGroup = null, this.parentRenderGroupIndex = 0, this.didChange = !1, this.didViewUpdate = !1, this.relativeRenderGroupDepth = 0, this.children = [], this.parent = null, this.includeInBuild = !0, this.measurable = !0, this.isSimple = !0, this.parentRenderLayer = null, this.updateTick = -1, this.localTransform = new x(), this.relativeGroupTransform = new x(), this.groupTransform = this.relativeGroupTransform, this.destroyed = !1, this._position = new m(this, 0, 0), this._scale = jt, this._pivot = J, this._origin = Mt, this._skew = At, this._cx = 1, this._sx = 0, this._cy = 0, this._sy = 1, this._rotation = 0, this.localColor = 16777215, this.localAlpha = 1, this.groupAlpha = 1, this.groupColor = 16777215, this.groupColorAlpha = 4294967295, this.localBlendMode = "inherit", this.groupBlendMode = "normal", this.localDisplayStatus = 7, this.globalDisplayStatus = 7, this._didContainerChangeTick = 0, this._didViewChangeTick = 0, this._didLocalTransformChangeId = -1, this.effects = [], kt(this, e, {
			children: !0,
			parent: !0,
			effects: !0
	...
	enableRenderGroup() {
		...
		e?.removeChild(this), this.renderGroup = W.get(Ot, this), this.groupTransform = x.IDENTITY, e?.addChild(this), this._updateIsSimple();
	}
	disableRenderGroup() {
		if (!this.renderGroup) return;
		let e = this.parentRenderGroup;
		e?.removeChild(this), W.return(this.renderGroup), this.renderGroup = null, this.groupTransform = this.relativeGroupTransform, e?.addChild(this), this._updateIsSimple();
	}
	_updateIsSimple() {
	...
	get pivot() {
		return this._pivot === J && (this._pivot = new m(this, 0, 0)), this._pivot;
	}
	set pivot(e) {
		this._pivot === J && (this._pivot = new m(this, 0, 0), this._origin !== Mt && U("Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.")), typeof e == "number" ? this._pivot.set(e) : this._pivot.copyFrom(e);
	}
	get skew() {
		return this._skew === At && (this._skew = new m(this, 0, 0)), this._skew;
	}
	set skew(e) {
		this._skew === At && (this._skew = new m(this, 0, 0)), this._skew.copyFrom(e);
	}
	get scale() {
		return this._scale === jt && (this._scale = new m(this, 1, 1)), this._scale;
	}
	set scale(e) {
		this._scale === jt && (this._scale = new m(this, 0, 0)), typeof e == "string" && (e = parseFloat(e)), typeof e == "number" ? this._scale.set(e) : this._scale.copyFrom(e);
	}
	get origin() {
		return this._origin === Mt && (this._origin = new m(this, 0, 0)), this._origin;
	}
	set origin(e) {
		this._origin === Mt && (this._origin = new m(this, 0, 0), this._pivot !== J && U("Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.")), typeof e == "number" ? this._origin.set(e) : this._origin.copyFrom(e);
	}
	get width() {
...
p.mixin(Nt, tt, ct, wt, xt, bt, at, ot, St, Je, $e, ht, nt);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/view/ViewContainer.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/ticker/const.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/getTestContext.mjs
var Gt;
function Kt() {
	return (!Gt || Gt?.isContextLost()) && (Gt = Lt.get().createCanvas().getContext("webgl", {})), Gt;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/getMaxFragmentPrecision.mjs
var qt;
function Jt() {
	if (!qt) {
		qt = "mediump";
		let e = Kt();
		e && e.getShaderPrecisionFormat && (qt = e.getShaderPrecisionFormat(e.FRAGMENT_SHADER, e.HIGH_FLOAT).precision ? "highp" : "mediump");
	}
	return qt;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/preprocessors/addProgramDefines.mjs
function Yt(e, t, n) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/preprocessors/ensurePrecision.mjs
function Xt(e, t, n) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/preprocessors/insertVersion.mjs
function Zt(e, t) {
	return t ? `#version 300 es
${e}` : e;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/preprocessors/setProgramName.mjs
var Qt = {}, $t = {};
function en(e, { name: t = "pixi-program" }, n = !0) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/preprocessors/stripVersion.mjs
function tn(e, t) {
	return t ? e.replace("#version 300 es", "") : e;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/GlProgram.mjs
var nn = {
	stripVersion: tn,
	ensurePrecision: Xt,
	addProgramDefines: Yt,
	setProgramName: en,
	insertVersion: Zt
}, X = /* @__PURE__ */ Object.create(null), rn = class e {
	constructor(t) {
		t = {
			...e.defaultOptions,
			...t
		...
		let n = t.fragment.indexOf("#version 300 es") !== -1, r = {
			...
			ensurePrecision: {
				...
				maxSupportedFragmentPrecision: Jt()
			},
		...
		Object.keys(nn).forEach((e) => {
			let t = r[e];
			i = nn[e](i, t, !0), a = nn[e](a, t, !1);
		}), this.fragment = i, this.vertex = a, this.transformFeedbackVaryings = t.transformFeedbackVaryings, this._key = Y(`${this.vertex}:${this.fragment}`, "gl-program");
	}
	destroy() {
...
function sn(e) {
	return on[e] ?? on.float32;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/extractAttributesFromGpuProgram.mjs
var cn = {
	f32: "float32",
	"vec2<f32>": "float32x2",
	"vec3<f32>": "float32x3",
	...
	"vec3<bool>": "uint32x3",
	"vec4<bool>": "uint32x4"
}, ln = /@location\((\d+)\)\s+([a-zA-Z0-9_]+)\s*:\s*([a-zA-Z0-9_<>]+)(?:,|\s|\)|$)/g;
function un(e, t) {
	let n;
	for (; (n = ln.exec(e)) !== null;) {
		let e = cn[n[3]] ?? "float32";
		t[n[2]] = {
...
function fn({ source: e, entryPoint: t }) {
	let n = {}, r = dn(e), i = r.indexOf(`fn ${t}(`);
	if (i === -1) return n;
	let a = r.indexOf("->", i);
	if (a === -1) return n;
	let o = r.substring(i, a);
	if (un(o, n), Object.keys(n).length === 0) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/extractStructAndGroups.mjs
function pn(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/shared/shader/const.mjs
var Z = /* @__PURE__ */ ((e) => (e[e.VERTEX = 1] = "VERTEX", e[e.FRAGMENT = 2] = "FRAGMENT", e[e.COMPUTE = 4] = "COMPUTE", e))(Z || {});
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/generateGpuLayoutGroups.mjs
function mn({ groups: e }) {
	let t = [];
	for (let n = 0; n < e.length; n++) {
		let r = e[n];
		t[r.group] || (t[r.group] = []), r.accessMode === "uniform" ? t[r.group].push({
			binding: r.binding,
			visibility: Z.VERTEX | Z.FRAGMENT,
			buffer: { type: "uniform" }
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/generateLayoutHash.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/removeStructAndGroupDuplicates.mjs
function gn(e, t) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/GpuProgram.mjs
var Q = /* @__PURE__ */ Object.create(null), _n = class e {
	constructor(e) {
		...
		if (this.name = a, this.fragment = t, this.vertex = n, t.source === n.source) {
			...
			let e = pn(n.source), r = pn(t.source);
			this.structsAndGroups = gn(e, r);
		}
		this.layout = r ?? hn(this.structsAndGroups), this.gpuLayout = i ?? mn(this.structsAndGroups), this.autoAssignGlobalUniforms = this.layout[0]?.globalUniforms !== void 0, this.autoAssignLocalUniforms = this.layout[1]?.localUniforms !== void 0, this._generateProgramKey();
	}
	_generateProgramKey() {
		let { vertex: e, fragment: t } = this, n = e.source + t.source + e.entryPoint + t.entryPoint;
		this._layoutKey = Y(n, "program");
	}
	get attributeData() {
		return this._attributeData ??= fn(this.vertex), this._attributeData;
	}
	destroy() {
		this.gpuLayout = null, this.layout = null, this.structsAndGroups = null, this.fragment = null, this.vertex = null, Q[this._cacheKey] = null;
	}
	static from(t) {
	...
	"vec3<u32>",
	"vec4<u32>"
], yn = vn.reduce((e, t) => (e[t] = !0, e), {});
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/shared/shader/utils/getDefaultUniformValue.mjs
function bn(e, t) {
	switch (e) {
		case "f32": return 0;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/shared/shader/UniformGroup.mjs
var xn = class e extends h {
	constructor(t, n) {
		super(), this._touched = 0, this.uid = k("uniform"), this._resourceType = "uniformGroup", this._resourceId = k("resource"), this.isUniformGroup = !0, this._dirtyId = 0, this.destroyed = !1, n = {
			...e.defaultOptions,
			...n
		...
		for (let e in t) {
			let n = t[e];
			if (n.name = e, n.size = n.size ?? 1, !yn[n.type]) {
				let e = n.type.match(/^array<(\w+(?:<\w+>)?),\s*(\d+)>$/);
				if (e) {
					let [, t, r] = e;
					throw Error(`Uniform type ${n.type} is not supported. Use type: '${t}', size: ${r} instead.`);
				}
				throw Error(`Uniform type ${n.type} is not supported. Supported uniform types are: ${vn.join(", ")}`);
			}
			n.value ??= bn(n.type, n.size), r[e] = n.value;
		}
		this.uniforms = r, this._dirtyId = 1, this.ubo = n.ubo, this.isStatic = n.isStatic, this._signature = Y(Object.keys(r).map((e) => `${e}-${t[e].type}`).join("-"), "uniform-group");
	}
	get buffer() {
		return this._buffer;
	}
	...
	onBufferChange() {
		this._resourceId = k("resource"), this.emit("change", this);
	}
	update() {
		this._dirtyId++;
	}
...
var Sn = xn, Cn = class {
	...
	onResourceChange(e) {
		if (this._dirty = !0, e.destroyed) {
			...
			U(`[BindGroup] a '${e._resourceType}' was destroyed while still bound to a shader. Remove it from the shader before destroying it.`);
		}
	}
}, wn = /* @__PURE__ */ ((e) => (e[e.WEBGL = 1] = "WEBGL", e[e.WEBGPU = 2] = "WEBGPU", e[e.CANVAS = 4] = "CANVAS", e[e.BOTH = 3] = "BOTH", e))(wn || {}), Tn = class e {
	constructor(e) {
		this.data = { ...e };
		let t = Object.keys(e).sort().map((t) => `${t}:${e[t]}`).join("|");
		this.id = Y(t, "shader-overrides");
	}
	static from(t) {
		return t instanceof e ? t : new e(t);
	}
}, En = class e extends h {
	constructor(e) {
		super(), this.uid = k("shader"), this._uniformBindMap = /* @__PURE__ */ Object.create(null), this._ownedBindGroups = [], this._destroyed = !1;
		let { gpuProgram: t, glProgram: n, groups: r, resources: i, compatibleRenderers: a, groupMap: o, overrides: s } = e;
		this._overrides = s ? Tn.from(s) : null, this.gpuProgram = t, this.glProgram = n, a === void 0 && (a = 0, t && (a |= wn.WEBGPU), n && (a |= wn.WEBGL)), this.compatibleRenderers = a;
		let c = {};
		if (o) for (let e in o) for (let t in o[e]) {
			let n = o[e][t];
			c[n] = {
				group: e,
				binding: t,
		...
		if (t && r && !o) {
			...
			o = {}, e.forEach((e) => {
				o[e.group] = o[e.group] || {}, o[e.group][e.binding] = e.name, c[e.name] = e;
			});
		} else if (i) {
			...
			let e = 0;
			for (let a in i) c[a] || (t && !n && U(`[Shader] the resource '${a}' matches no binding in the WGSL source \u2014 is the name correct?`), r[99] || (r[99] = new Cn(), this._ownedBindGroups.push(r[99])), c[a] = {
				group: 99,
				binding: e,
				name: a
			}, o[99] = o[99] || {}, o[99][e] = a, e++);
			for (let e in i) {
				let t = e, n = i[e];
				!n.source && !n._resourceType && (n = new Sn(n));
				let a = c[t];
				a && (r[a.group] || (r[a.group] = new Cn(), this._ownedBindGroups.push(r[a.group])), r[a.group].setResource(n, a.binding));
			}
		}
		this.groups = r, this._uniformBindMap = o, this.resources = this._buildResourceAccessor(r, c);
	}
	addResource(e, t, n) {
		var r, i;
		(r = this._uniformBindMap)[t] || (r[t] = {}), (i = this._uniformBindMap[t])[n] || (i[n] = e), this.groups[t] || (this.groups[t] = new Cn(), this._ownedBindGroups.push(this.groups[t]));
	}
	...
	static from(t) {
		...
		return n && (a = _n.from(n)), r && (o = an.from(r)), new e({
			gpuProgram: a,
			glProgram: o,
			...i
		});
	...
	WINDING: 4,
	DEPTH_MASK: 5
}, { BLEND: kn, OFFSET: An, CULLING: jn, DEPTH_TEST: Mn, WINDING: Nn, DEPTH_MASK: Pn } = On, Fn = class e {
	constructor() {
	...
	set offsets(e) {
		!!(this.data & 1 << An) !== e && (this.data ^= 1 << An);
	}
	set cullMode(e) {
		if (e === "none") {
			this.culling = !1;
	...
	set depthTest(e) {
		!!(this.data & 1 << Mn) !== e && (this.data ^= 1 << Mn);
	}
	get depthMask() {
		return !!(this.data & 1 << Pn);
	}
	set depthMask(e) {
		!!(this.data & 1 << Pn) !== e && (this.data ^= 1 << Pn);
	}
...
Fn.default2d = Fn.for2d();
var In = Fn, Ln = class e extends En {
	constructor(t) {
		t = {
			...e.defaultOptions,
			...t
		}, super(t), this.enabled = !0, this._state = In.for2d(), this.blendMode = t.blendMode, this.padding = t.padding, this.antialias = typeof t.antialias == "boolean" ? t.antialias ? "on" : "off" : t.antialias, this.resolution = t.resolution, this.blendRequired = t.blendRequired, this.clipToViewport = t.clipToViewport, this.addResource("uTexture", 0, 1), t.blendRequired && this.addResource("uBackTexture", 0, 3);
	}
	apply(e, t, n, r) {
...
var Rn = Ln, $ = /* @__PURE__ */ ((e) => (e[e.MAP_READ = 1] = "MAP_READ", e[e.MAP_WRITE = 2] = "MAP_WRITE", e[e.COPY_SRC = 4] = "COPY_SRC", e[e.COPY_DST = 8] = "COPY_DST", e[e.INDEX = 16] = "INDEX", e[e.VERTEX = 32] = "VERTEX", e[e.UNIFORM = 64] = "UNIFORM", e[e.STORAGE = 128] = "STORAGE", e[e.INDIRECT = 256] = "INDIRECT", e[e.QUERY_RESOLVE = 512] = "QUERY_RESOLVE", e[e.STATIC = 1024] = "STATIC", e))($ || {}), zn = class extends h {
	constructor(e) {
		let { data: t, size: n } = e, { usage: r, label: i, shrinkToFit: a } = e;
		super(), this._gpuData = /* @__PURE__ */ Object.create(null), this._gcLastUsed = -1, this.autoGarbageCollect = !0, this.uid = k("buffer"), this._resourceType = "buffer", this._resourceId = k("resource"), this._touched = 0, this._updateID = 1, this._updateOffset = 0, this._dataInt32 = null, this.shrinkToFit = !0, this.destroyed = !1, t instanceof Array && (t = new Float32Array(t)), this._data = t, n ??= t?.byteLength;
		let o = !!t;
		this.descriptor = {
			size: n,
			usage: r,
	...
	set static(e) {
		e ? this.descriptor.usage |= $.STATIC : this.descriptor.usage &= ~$.STATIC;
	}
	setDataWithSize(e, t, n) {
		if (this._updateID++, this._updateSize = t * e.BYTES_PER_ELEMENT, this._updateOffset = 0, this._data === e) {
	...
	unload() {
		this.emit("unload", this);
		for (let e in this._gpuData) this._gpuData[e]?.destroy();
		this._gpuData = /* @__PURE__ */ Object.create(null), this.destroyed || (this._resourceId = k("resource"), this.emit("change", this));
	}
	destroy() {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/shared/geometry/utils/ensureIsBuffer.mjs
function Bn(e, t) {
	if (!(e instanceof zn)) {
		let n = t ? $.INDEX : $.VERTEX;
		e instanceof Array && (t ? (e = new Uint32Array(e), n = $.INDEX | $.COPY_DST) : (e = new Float32Array(e), n = $.VERTEX | $.COPY_DST)), e = new zn({
			data: e,
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/shared/geometry/utils/getGeometryBounds.mjs
function Vn(e, t, n) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/shared/geometry/Geometry.mjs
function Hn(e) {
	return (e instanceof zn || Array.isArray(e) || e.BYTES_PER_ELEMENT) && (e = { buffer: e }), e.buffer = Bn(e.buffer, !1), e;
}
var Un = class extends h {
	constructor(e = {}) {
		super(), this._gpuData = /* @__PURE__ */ Object.create(null), this.autoGarbageCollect = !0, this._gcLastUsed = -1, this.uid = k("geometry"), this._layoutKey = 0, this.instanceCount = 1, this._bounds = new F(), this._boundsDirty = !0, this._vertexCount = 0, this._vertexCountDirty = !0;
	...
	getSize() {
		return M("8.20.0", "Geometry.getSize is deprecated, please use Geometry.vertexCount instead."), this.vertexCount;
	}
	addAttribute(e, t) {
		let n = Hn(t);
	...
	addIndex(e) {
		this.indexBuffer = Bn(e, !0), this.buffers.push(this.indexBuffer);
	}
	get bounds() {
		return this._boundsDirty ? (this._boundsDirty = !1, Vn(this, "aPosition", this._bounds)) : this._bounds;
	}
	unload() {
		this.emit("unload", this);
		for (let e in this._gpuData) this._gpuData[e]?.destroy();
...
//#endregion
export { ae as $, ft as A, F as B, Nt as C, gt as D, Tt as E, et as F, N as G, P as H, W as I, ue as J, ge as K, Ze as L, K as M, G as N, q as O, rt as P, k as Q, U as R, Pt as S, Dt as T, be as U, xe as V, ve as W, A as X, M as Y, ce as Z, Ht as _, On as a, u as at, Lt as b, Tn as c, Sn as d, D as et, _n as f, Y as g, Kt as h, Rn as i, m as it, lt as j, mt as k, wn as l, an as m, zn as n, y as nt, In as o, p as ot, sn as p, fe as q, $ as r, h as rt, En as s, s as st, Un as t, x as tt, Cn as u, zt as v, Ot as w, Ft as x, Rt as y, qe as z };

//# sourceMappingURL=Geometry-D1neCpWU.js.map