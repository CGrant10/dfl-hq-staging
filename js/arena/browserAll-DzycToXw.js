import { C as e, F as t, R as n, _ as r, at as i, nt as a, ot as o, rt as s, v as c } from "./Geometry-D1neCpWU.js";
import "./getPo2TextureFromSource-Drp0bisT.js";
import "./init-MJ2qrpeE.js";
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/dom/CanvasObserver.mjs
var l = class {
	constructor(e) {
	...
	_attachObserver() {
		...
		}), this._observer.observe(this._canvas)) : this._tickerAttached || r.shared.add(this.updateTranslation, this, c.HIGH);
	}
	destroy() {
		this._observer ? (this._observer.disconnect(), this._observer = null) : this._tickerAttached && r.shared.remove(this.updateTranslation), this._domElement = null, this._renderer = null, this._canvas = null, this._tickerAttached = !1, this._lastTransform = "", this._lastScaleX = null, this._lastScaleY = null;
	}
}, u = class e {
	constructor(t) {
		this.bubbles = !0, this.cancelBubble = !0, this.cancelable = !1, this.composed = !1, this.defaultPrevented = !1, this.eventPhase = e.prototype.NONE, this.propagationStopped = !1, this.propagationImmediatelyStopped = !1, this.layer = new a(), this.page = new a(), this.NONE = 0, this.CAPTURING_PHASE = 1, this.AT_TARGET = 2, this.BUBBLING_PHASE = 3, this.manager = t;
	}
	get layerX() {
		return this.layer.x;
	}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/utils/browser/isMobile.mjs
...
var U = new class {
	...
	addTickerListener() {
		this._tickerAdded || !this.domElement || (r.system.add(this._tickerUpdate, this, c.INTERACTION), this._tickerAdded = !0);
	}
	removeTickerListener() {
		this._tickerAdded &&= (r.system.remove(this._tickerUpdate, this), !1);
	}
	pointerMoved() {
		this._didMove = !0;
	}
	...
	constructor() {
		super(...arguments), this.client = new a(), this.movement = new a(), this.offset = new a(), this.global = new a(), this.screen = new a();
	}
	get clientX() {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/events/EventBoundary.mjs
var q = 2048, J = new a(), Y = new a(), X = class {
	constructor(e) {
	...
	copyPointerData(e, t) {
		e instanceof G && t instanceof G && (t.pointerId = e.pointerId, t.width = e.width, t.height = e.height, t.isPrimary = e.isPrimary, t.pointerType = e.pointerType, t.pressure = e.pressure, t.tangentialPressure = e.tangentialPressure, t.tiltX = e.tiltX, t.tiltY = e.tiltY, t.twist = e.twist, t.persistentDeviceId = e.persistentDeviceId);
	}
	copyMouseData(e, t) {
...
var $ = Q;
o.add(B), o.mixin(e, V), o.add(H), o.add($), o.mixin(e, {
	onclick: null,
	onmousedown: null,
	onmouseenter: null,
	onmouseleave: null,
...
//# sourceMappingURL=browserAll-DzycToXw.js.map