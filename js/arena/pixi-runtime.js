import { $ as e, A as t, B as n, C as r, E as i, G as a, H as o, I as s, J as c, K as l, O as u, Q as d, R as f, S as p, T as m, V as h, X as g, Y as _, Z as v, _ as y, a as b, at as x, b as S, c as C, d as w, et as T, g as E, it as D, l as O, m as k, n as A, nt as j, o as M, ot as N, p as P, q as ee, r as F, rt as te, s as ne, st as re, t as ie, tt as I, u as ae, v as L, y as oe, z as R } from "./Geometry-D1neCpWU.js";
import { t as se } from "./getPo2TextureFromSource-Drp0bisT.js";
import { n as ce, r as le, t as z } from "./canvasUtils-DlqG_Aub.js";
import { C as ue, D as de, E as fe, O as B, S as pe, T as me, _ as he, a as ge, b as _e, c as ve, d as ye, f as V, g as be, h as xe, i as Se, l as Ce, m as we, n as Te, o as Ee, p as De, r as Oe, s as ke, t as Ae, u as je, v as Me, w as Ne, x as Pe, y as Fe } from "./RenderTargetSystem-CS96Nwii.js";
import { t as Ie } from "./getTextureBatchBindGroup-CtL7Ot9Y.js";
import { t as Le } from "./CanvasPool-DlfXgyy9.js";
import { a as Re, c as ze, d as Be, f as Ve, i as He, l as Ue, n as We, o as Ge, p as Ke, r as qe, s as Je, t as Ye, u as Xe } from "./BufferResource-DZ1aXRWI.js";
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/environment-browser/browserExt.mjs
var Ze = {
	extension: {
		type: x.Environment,
		name: "browser",
	...
	test: () => !0,
	load: async () => {
		await import("./browserAll-DzycToXw.js");
	}
}, Qe = {
	extension: {
		type: x.Environment,
	...
	load: async () => {
		await import("./webworkerAll-CLMZZF5m.js");
	}
}, $e = /* @__PURE__ */ new Set(), et = !1;
function tt(e, t, n = 2) {
	let r = t && t.length, i = r ? t[0] * n : e.length;
	$e.size && $e.clear();
	let a = nt(e, 0, i, n, !0), o = [];
	if (!a || a.next === a.prev) return o;
	let s = 0, c = 0, l = 0;
	if (r && (a = ut(e, t, a, n)), e.length > 80 * n) {
		s = e[0], c = e[1];
		let t = s, r = c;
		for (let a = n; a < i; a += n) {
			let n = e[a], i = e[a + 1];
	...
	return it(a, o, s, c, l), o;
}
function nt(e, t, n, r, i) {
	let a = null;
	if (i === Gt(e, t, n, r) > 0) for (let i = t; i < n; i += r) a = Ht(i / r | 0, e[i], e[i + 1], a);
	else for (let i = n - r; i >= t; i -= r) a = Ht(i / r | 0, e[i], e[i + 1], a);
	return a && Ft(a, a.next) && (Ut(a), a = a.next), a;
}
function rt(e, t = e) {
	let n = t === e, r = e, i;
	do
		i = !1, r !== r.next && ($e.size === 0 || !$e.has(r)) && (Ft(r, r.next) || W(r.prev, r, r.next) === 0) ? ((n || r === t) && (t = r.prev), et = !0, Ut(r), r = r.prev, i = !0) : (n || r !== t) && (r = r.next, i = !n);
	while (i || r !== t);
	return t;
}
function it(e, t, n, r, i) {
	...
	for (; e.prev !== e.next;) {
		...
		if (W(s, e, c) < 0 && (i ? ot(e, n, r, i) : at(e))) {
			t.push(s.i, e.i, c.i), Ut(e), e = c, a = c;
			continue;
		}
		if (e = c, e === a) {
			if (et = !1, e = rt(e), et) {
...
function at(e) {
	...
	for (; m !== t;) {
		if (m.x >= u && m.x <= f && m.y >= d && m.y <= p && (i !== m.x || s !== m.y) && Nt(i, s, a, c, o, l, m.x, m.y) && W(m.prev, m, m.next) >= 0) return !1;
		m = m.next;
	}
	return !0;
}
function ot(e, t, n, r) {
	let i = e.prev, a = e, o = e.next, s = i.x, c = a.x, l = o.x, u = i.y, d = a.y, f = o.y, p = Math.min(s, c, l), m = Math.min(u, d, f), h = Math.max(s, c, l), g = Math.max(u, d, f), _ = jt(p, m, t, n, r), v = jt(h, g, t, n, r), y = e.prevZ;
	for (; y && y.z >= _;) {
		if (y.x >= p && y.x <= h && y.y >= m && y.y <= g && y !== o && (s !== y.x || u !== y.y) && Nt(s, u, c, d, l, f, y.x, y.y) && W(y.prev, y, y.next) >= 0) return !1;
		y = y.prevZ;
	}
	let b = e.nextZ;
	for (; b && b.z <= v;) {
		if (b.x >= p && b.x <= h && b.y >= m && b.y <= g && b !== o && (s !== b.x || u !== b.y) && Nt(s, u, c, d, l, f, b.x, b.y) && W(b.prev, b, b.next) >= 0) return !1;
		b = b.nextZ;
	}
	return !0;
}
function st(e, t) {
	...
	do {
		...
		It(i, n, n.next, a, !1) && zt(i, a) && zt(a, i) && (t.push(i.i, n.i, a.i), Ut(n), Ut(n.next), n = e = a, r = !0), n = n.next;
	} while (n !== e);
	return r ? rt(n) : n;
}
function ct(e, t, n, r, i) {
	...
	do {
		...
		for (; e !== a.prev;) {
			if (a.i !== e.i && Pt(a, e)) {
				let o = Vt(a, e);
				a = rt(a, a.next), o = rt(o, o.next), it(a, t, n, r, i), it(o, t, n, r, i);
				return;
			}
			e = e.next;
		}
...
function ut(e, t, n, r) {
	...
	for (let n = 0, a = t.length; n < a; n++) {
		let o = nt(e, t[n] * r, n < a - 1 ? t[n + 1] * r : e.length, r, !1);
		o === o.next && $e.add(o), i.push(Mt(o));
	}
	i.sort(dt), _t(e.length / r, t.length), vt(n, n), lt = !0;
	for (let e = 0; e < i.length; e++) n = ft(i[e], n);
	return lt = !1, rt(n);
}
function dt(e, t) {
...
function ft(e, t) {
	let n = St(e, t);
	if (!n) return t;
	let r = Vt(n, e), i = r.next;
	return vt(n, i.next), rt(r, r.next), rt(n, n.next);
}
var pt = 16, H = /* @__PURE__ */ new Float64Array(), mt = 0, ht = [], gt = [];
function _t(e, t) {
	let n = Math.ceil((e + 2 * t) / pt) + t + 2;
	H.length < n * 4 && (H = new Float64Array(n * 4)), mt = 0;
}
function vt(e, t) {
	let n = e;
	do {
		...
		gt[e] = n;
		let c = e * 4;
		H[c] = r, H[c + 1] = i, H[c + 2] = a, H[c + 3] = o;
	} while (n !== t);
}
function yt(e, t) {
	let n = e.z * 4;
	t.x < H[n] && (H[n] = t.x), t.y < H[n + 1] && (H[n + 1] = t.y), t.x > H[n + 2] && (H[n + 2] = t.x), t.y > H[n + 3] && (H[n + 3] = t.y);
}
function bt(e) {
	let t = gt[e];
...
function St(e, t) {
	...
	if (Ft(e, n)) return n;
	for (let t = 0, s = 0; t < mt; t++, s += 4) {
		if (i < H[s + 1] || i > H[s + 3] || H[s] > r || H[s + 2] <= a) continue;
		let c = bt(t);
		n = xt(t);
		do {
			if (n.prev.next === n) {
				if (Ft(e, n.next)) return n.next;
	...
	for (let t = 0, f = 0; t < mt; t++, f += 4) {
		if (H[f + 2] < s || H[f] > r || H[f + 3] < l || H[f + 1] > u) continue;
		let p = bt(t);
		n = xt(t);
		do {
			if (n.prev.next === n && r >= n.x && n.x >= s && r !== n.x && Nt(i < c ? r : a, i, s, c, i < c ? a : r, i, n.x, n.y)) {
				let t = Math.abs(i - n.y) / (r - n.x);
				(zt(n, e) || n.y === i && n.next.y === i && n.next.x > r) && (t < d || t === d && (n.x > o.x || n.x === o.x && Ct(o, n))) && (o = n, d = t);
			}
			n = n.next;
		} while (n !== p);
	}
...
var U = [], wt = [], Tt = /* @__PURE__ */ new Uint32Array(), Et = /* @__PURE__ */ new Uint32Array(), Dt = /* @__PURE__ */ new Uint32Array(256);
function Ot(e, t, n, r) {
	let i = e, a = 0;
	do
		i.z = jt(i.x, i.y, t, n, r), U[a++] = i, i = i.next;
	while (i !== e);
	kt(a);
	let o = null;
	for (let e = 0; e < a; e++) {
...
function kt(e) {
	if (e <= 32) {
		for (let t = 1; t < e; t++) {
			let e = U[t], n = e.z, r = t - 1;
			for (; r >= 0 && U[r].z > n;) U[r + 1] = U[r], r--;
			U[r + 1] = e;
		}
		return;
	}
	Tt.length < e && (Tt = new Uint32Array(e), Et = new Uint32Array(e), wt = Array(e));
	for (let t = 0; t < e; t++) Tt[t] = U[t].z;
	At(e, U, Tt, wt, Et, 0), At(e, wt, Et, U, Tt, 8), At(e, U, Tt, wt, Et, 16), At(e, wt, Et, U, Tt, 24);
}
function At(e, t, n, r, i, a) {
	Dt.fill(0);
	for (let t = 0; t < e; t++) Dt[n[t] >>> a & 255]++;
	let o = 0;
	for (let e = 0; e < 256; e++) {
		let t = Dt[e];
		Dt[e] = o, o += t;
...
function Pt(e, t) {
	let n = Ft(e, t) && W(e.prev, e, e.next) > 0 && W(t.prev, t, t.next) > 0;
	return e.next.i !== t.i && (n || zt(e, t) && zt(t, e) && (W(e.prev, e, t.prev) !== 0 || W(e, t.prev, t) !== 0)) && !Rt(e, t) && (n || Bt(e, t));
}
function W(e, t, n) {
...
function It(e, t, n, r, i = !0) {
	let a = W(e, t, n), o = W(e, t, r), s = W(n, r, e), c = W(n, r, t);
	return (a > 0 && o < 0 || a < 0 && o > 0) && (s > 0 && c < 0 || s < 0 && c > 0) ? !0 : i ? !!(a === 0 && Lt(e, n, t) || o === 0 && Lt(e, r, t) || s === 0 && Lt(n, e, r) || c === 0 && Lt(n, t, r)) : !1;
}
function Lt(e, t, n) {
...
function Rt(e, t) {
	...
	do {
		...
		if (o.i !== e.i && s.i !== e.i && o.i !== t.i && s.i !== t.i && It(o, s, e, t)) return !0;
		o = s;
	} while (o !== e);
	return !1;
}
...
function Vt(e, t) {
	let n = Wt(e.i, e.x, e.y), r = Wt(t.i, t.x, t.y), i = e.next, a = t.prev;
...
function Ut(e) {
	e.next.prev = e.prev, e.prev.next = e.next, e.prevZ && (e.prevZ.nextZ = e.nextZ), e.nextZ && (e.nextZ.prevZ = e.prevZ), lt && yt(e.prev, e.next);
}
function Wt(e, t, n) {
	return {
		i: e,
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/utils/utils.mjs
var Kt = tt.default || tt, qt;
function Jt(e) {
	return qt === void 0 && (qt = (() => {
		let t = {
			stencil: !0,
			failIfMajorPerformanceCaveat: e ?? de.defaultOptions.failIfMajorPerformanceCaveat
		};
		try {
			if (!S.get().getWebGLRenderingContext()) return !1;
			let e = S.get().createCanvas().getContext("webgl", t), n = !!e?.getContextAttributes()?.stencil;
			if (e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/utils/browser/isWebGPUSupported.mjs
var Yt;
async function Xt(e = {}) {
	return Yt === void 0 && (Yt = await (async () => {
		let t = S.get().getNavigator().gpu;
		if (!t) return !1;
		try {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/autoDetectRenderer.mjs
var Zt = [
	"webgl",
	"webgpu",
	"canvas"
...
async function Qt(e) {
	let t = [];
	e.preference ? Array.isArray(e.preference) ? t = e.preference.slice() : (t.push(e.preference), Zt.forEach((n) => {
		n !== e.preference && t.push(n);
	})) : t = Zt.slice();
	let n, r = {};
	for (let i = 0; i < t.length; i++) {
		let a = t[i];
		if (a === "webgpu" && await Xt()) {
			let { WebGPURenderer: t } = await Promise.resolve().then(() => Pc);
			n = t, r = {
				...e,
				...e.webgpu
			};
		...
		if (a === "webgl" && Jt(e.failIfMajorPerformanceCaveat ?? de.defaultOptions.failIfMajorPerformanceCaveat)) {
			let { WebGLRenderer: t } = await Promise.resolve().then(() => js);
			n = t, r = {
				...e,
				...e.webgl
			};
		...
		if (a === "canvas") {
			let { CanvasRenderer: t } = await Promise.resolve().then(() => Ka);
			n = t, r = {
				...e,
				...e.canvasOptions
			};
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/app/ResizePlugin.mjs
var $t = class {
	static init(e) {
...
$t.extension = x.Application;
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/app/TickerPlugin.mjs
var en = class {
	static init(e) {
		e = Object.assign({
			autoStart: !0,
			...
			configurable: !0,
			set(e) {
				this._ticker && this._ticker.remove(this.render, this), this._ticker = e, e && e.add(this.render, this, L.LOW);
			},
			get() {
				return this._ticker;
			}
			...
			this._ticker.start();
		}, this._ticker = null, this.ticker = e.sharedTicker ? y.shared : new y(), e.autoStart && this.start();
	}
	static destroy() {
		if (this._ticker) {
			let e = this._ticker;
...
en.extension = x.Application, N.add($t), N.add(en);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/app/Application.mjs
var tn = class e {
	constructor(...e) {
		this.stage = new r(), e[0] !== void 0 && _(g, "Application constructor options are deprecated, please use Application.init() instead.");
	}
	async init(t) {
		t = { ...t }, this.stage ||= new r(), this.renderer = await Qt(t), e._plugins.forEach((e) => {
			e.init.call(this, t);
		});
	}
	render() {
	...
	get view() {
		return _(g, "Application.view is deprecated, please use Application.canvas instead."), this.renderer.canvas;
	}
	get screen() {
...
tn._plugins = [];
var nn = tn;
N.handleByList(x.Application, nn._plugins), N.add(fe);
//#endregion
//#region node_modules/.pnpm/parse-svg-path@0.2.0/node_modules/parse-svg-path/dist/index.mjs
var rn = {
	a: 7,
	c: 6,
	h: 1,
	...
	v: 1,
	z: 0
}, an = /([astvzqmhlc])([^astvzqmhlc]*)/gi, on = /-?[0-9]*\.?[0-9]+(?:e[-+]?\d+)?/gi;
function sn(e) {
	let t = [];
	return e.replace(an, (e, n, r) => {
		let i = n.toLowerCase(), a = n, o = cn(r);
		for (i === "m" && o.length > 2 && (t.push([a, ...o.splice(0, 2)]), i = "l", a = a === "m" ? "l" : "L");;) {
			if (o.length === rn[i]) return t.push([a, ...o]), "";
			if (o.length < rn[i]) throw Error("malformed path data");
			t.push([a, ...o.splice(0, rn[i])]);
		}
	}), t;
}
function cn(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/svg/parseSVGPath.mjs
function ln(e, t) {
	let n = sn(e), r = [], i = null, a = 0, o = 0;
	for (let e = 0; e < n.length; e++) {
		...
		switch (c) {
			...
			case "z":
				...
				break;
			default: f(`Unknown SVG path command: ${c}`);
		}
		c !== "Z" && c !== "z" && i === null && (i = {
			startX: a,
			startY: o
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/maths/shapes/Circle.mjs
var un = class t {
	...
	getBounds(t) {
		return t ||= new e(), t.x = this.x - this.radius, t.y = this.y - this.radius, t.width = this.radius * 2, t.height = this.radius * 2, t;
	}
	copyFrom(e) {
	...
	clone() {
		return new t(this.x, this.y, this.halfWidth, this.halfHeight);
	}
	contains(e, t) {
	...
	getBounds(t) {
		return t ||= new e(), t.x = this.x - this.halfWidth, t.y = this.y - this.halfHeight, t.width = this.halfWidth * 2, t.height = this.halfHeight * 2, t;
	}
	copyFrom(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/maths/misc/getOrientationOfPoints.mjs
function fn(e) {
	let t = e.length;
	if (t < 6) return 1;
	let n = 0;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/maths/misc/squaredDistanceToLineSegment.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/maths/shapes/Polygon.mjs
var mn, hn, gn = class t {
	constructor(...e) {
		this.type = "polygon";
	...
	containsPolygon(e) {
		let t = this.getBounds(mn), n = e.getBounds(hn);
	...
	clone() {
		let e = this.points.slice(), n = new t(e);
	...
	strokeContains(e, t, n, r = .5) {
		let { points: i } = this, a = n * (r === .5 ? r : (r - .5) * fn(i) + .5), o = n - a, s = a * a, c = o * o, l = i.length - (this.closePath ? 0 : 2);
		for (let n = 0; n < l; n += 2) {
			let r = i[n], a = i[n + 1], o = i[(n + 2) % i.length], l = i[(n + 3) % i.length];
			if (pn(e, t, r, a, o, l) <= (Math.sign((o - r) * (t - a) - (l - a) * (e - r)) < 0 ? s : c)) return !0;
		}
		return !1;
	}
	getBounds(t) {
		t ||= new e();
		let n = this.points, r = Infinity, i = -Infinity, a = Infinity, o = -Infinity;
		for (let e = 0, t = n.length; e < t; e += 2) {
			let t = n[e], s = n[e + 1];
			r = t < r ? t : r, i = t > i ? t : i, a = s < a ? s : a, o = s > o ? s : o;
		}
		return t.x = r, t.width = i - r, t.y = a, t.height = o - a, t;
	}
	copyFrom(e) {
	...
	get x() {
		return _("8.11.0", "Polygon.lastX is deprecated, please use Polygon.lastX instead."), this.points[this.points.length - 2];
	}
	get y() {
		return _("8.11.0", "Polygon.y is deprecated, please use Polygon.lastY instead."), this.points[this.points.length - 1];
	}
	get startX() {
	...
	getBounds(t) {
		return t ||= new e(), t.x = this.x, t.y = this.y, t.width = this.width, t.height = this.height, t;
	}
	clone() {
	...
	strokeContains(e, t, n, r = .5) {
		...
		return (e >= i - l && e <= i + u || e >= h - u && e <= h + l) && t >= f && t <= f + m || (t >= a - l && t <= a + u || t >= g - u && t <= g + l) && e >= d && e <= d + p || e < d && t < f && _n(e, t, d, f, c, u, l) || e > h - c && t < f && _n(e, t, h - c, f, c, u, l) || e > h - c && t > g - c && _n(e, t, h - c, g - c, c, u, l) || e < d && t > g - c && _n(e, t, d, g - c, c, u, l);
	}
	toString() {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/shared/geometry/utils/buildUvs.mjs
function yn(e, t, n, r, i, a, o, s = null) {
	let c = 0;
	n *= t, i *= a;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/shared/geometry/utils/transformVertices.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/BatchableGraphics.mjs
var Sn = new I(), Cn = class {
	constructor() {
	...
	get color() {
		let e = this.baseColor, n = e >> 16 | e & 65280 | (e & 255) << 16, r = this.renderable;
		return r ? t(n, r.groupColor) + (this.alpha * r.groupAlpha * 255 << 24) : n + (this.alpha * 255 << 24);
	}
	get transform() {
		return this.renderable?.groupTransform || Sn;
	}
	copyTo(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildLine.mjs
...
function jn(e, t, n, r, i, a) {
	...
	let l = new j(e[0], e[1]), u = new j(e[e.length - 2], e[e.length - 1]), d = r, f = Math.abs(l.x - u.x) < o && Math.abs(l.y - u.y) < o;
	if (d) {
	...
	d || (s.cap === "round" ? h += An(b - E * (N - P) * .5, x - D * (N - P) * .5, b - E * N, x - D * N, b + E * P, x + D * P, p, !0) + 2 : s.cap === "square" && (h += kn(b, x, E, D, N, P, !0, p))), p.push(b - E * N, x - D * N), p.push(b + E * P, x + D * P);
	for (let t = 1; t < m - 1; ++t) {
		...
		if (Math.abs(c) < .001 * Math.abs(o)) {
			p.push(S - E * N, C - D * N), p.push(S + E * P, C + D * P), o >= 0 && (s.join === "round" ? h += An(S, C, S - E * N, C - D * N, S - O * N, C - k * N, p, !1) + 4 : h += 2, p.push(S - O * P, C - k * P), p.push(S + O * N, C + k * N));
			continue;
		}
		let u = (-E + b) * (-D + C) - (-E + S) * (-D + x), d = (-O + w) * (-k + C) - (-O + S) * (-k + T), f = (n * d - i * u) / c, m = (a * u - r * d) / c, g = (f - S) * (f - S) + (m - C) * (m - C), j = S + (f - S) * N, M = C + (m - C) * N, ee = S - (f - S) * P, F = C - (m - C) * P, te = Math.min(n * n + r * r, i * i + a * a), ne = l ? N : P;
		g <= te + ne * ne * v ? s.join === "bevel" || g / v > y ? (l ? (p.push(j, M), p.push(S + E * P, C + D * P), p.push(j, M), p.push(S + O * P, C + k * P)) : (p.push(S - E * N, C - D * N), p.push(ee, F), p.push(S - O * N, C - k * N), p.push(ee, F)), h += 2) : s.join === "round" ? l ? (p.push(j, M), p.push(S + E * P, C + D * P), h += An(S, C, S + E * P, C + D * P, S + O * P, C + k * P, p, !0) + 4, p.push(j, M), p.push(S + O * P, C + k * P)) : (p.push(S - E * N, C - D * N), p.push(ee, F), h += An(S, C, S - E * N, C - D * N, S - O * N, C - k * N, p, !1) + 4, p.push(S - O * N, C - k * N), p.push(ee, F)) : (p.push(j, M), p.push(ee, F)) : (p.push(S - E * N, C - D * N), p.push(S + E * P, C + D * P), s.join === "round" ? h += l ? An(S, C, S + E * P, C + D * P, S + O * P, C + k * P, p, !0) + 2 : An(S, C, S - E * N, C - D * N, S - O * N, C - k * N, p, !1) + 2 : s.join === "miter" && g / v <= y && (l ? (p.push(ee, F), p.push(ee, F)) : (p.push(j, M), p.push(j, M)), h += 2), p.push(S - O * N, C - k * N), p.push(S + O * P, C + k * P), h += 2);
	}
	b = e[(m - 2) * 2], x = e[(m - 2) * 2 + 1], S = e[(m - 1) * 2], C = e[(m - 1) * 2 + 1], E = -(x - C), D = b - S, A = Math.sqrt(E * E + D * D), E /= A, D /= A, E *= _, D *= _, p.push(S - E * N, C - D * N), p.push(S + E * P, C + D * P), d || (s.cap === "round" ? h += An(S - E * (N - P) * .5, C - D * (N - P) * .5, S - E * N, C - D * N, S + E * P, C + D * P, p, !1) + 2 : s.cap === "square" && (h += kn(S, C, E, D, N, P, !1, p)));
	let ee = On * On;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildPixelLine.mjs
function Mn(e, t, n, r) {
	let i = Dn;
	if (e.length === 0) return;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/utils/triangulateWithHoles.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildPolygon.mjs
var Pn = [], Fn = {
	extension: {
		type: x.ShapeBuilder,
		name: "polygon"
	...
	addColorStop(e, t) {
		return this.colorStops.push({
			offset: e,
			color: R.shared.setValue(t).toHexa()
		}), this;
	}
	buildLinearGradient() {
		...
		let c = this.colorStops.length ? this.colorStops : Rn, l = this._textureSize, { canvas: u, context: d } = Vn(l, 1), f = s ? d.createLinearGradient(this._textureSize, 0, 0, 0) : d.createLinearGradient(0, 0, this._textureSize, 0);
		Bn(f, c), d.fillStyle = f, d.fillRect(0, 0, l, 1), this.texture = new o({ source: new le({
			resource: u,
			addressMode: this._wrapMode
		}) });
		let p = Math.sqrt(i * i + a * a), m = Math.atan2(a, i), h = new I();
	...
	buildRadialGradient() {
		if (this.texture) return;
		let e = this.colorStops.length ? this.colorStops : Rn, t = this._textureSize, { canvas: n, context: r } = Vn(t, t), { x: i, y: a } = this.center, { x: s, y: c } = this.outerCenter, l = this.innerRadius, u = this.outerRadius, d = s - u, f = c - u, p = t / (u * 2), m = (i - d) * p, h = (a - f) * p, g = r.createRadialGradient(m, h, l * p, (s - d) * p, (c - f) * p, u * p);
		Bn(g, e), r.fillStyle = e[e.length - 1].color, r.fillRect(0, 0, t, t), r.fillStyle = g, r.translate(m, h), r.rotate(this.rotation), r.scale(1, this.scale), r.translate(-m, -h), r.fillRect(0, 0, t, t), this.texture = new o({ source: new le({
			resource: n,
			addressMode: this._wrapMode
		}) });
		let _ = new I();
...
function Hn(e) {
	let t = e[0] ?? {};
	return (typeof t == "number" || e[1]) && (_("8.5.2", "use options object instead"), t = {
		type: "linear",
		start: {
			x: e[0],
			y: e[1]
		...
		textureSpace: e[4],
		textureSize: e[5] ?? G.defaultLinearOptions.textureSize
	}), t;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/utils/generateTextureFillMatrix.mjs
var Un = new I(), Wn = new e(), Gn = new I();
function Kn(e, t, n, r) {
	let i = t.matrix ? e.copyFrom(t.matrix).invert() : e.identity();
	if (t.textureSpace === "local") {
		let e = n.getBounds(Wn);
		...
		i.scale(1 / n.width, 1 / n.height), i.prepend(Gn.set(e.x1 - e.x0, e.y1 - e.y0, e.x3 - e.x0, e.y3 - e.y0, e.x0, e.y0));
	...
	return !(t.fill instanceof G) && a.addressMode === "clamp-to-edge" && (a.addressMode = "repeat", a.update()), r && i.append(Un.copyFrom(r).invert()), i;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/utils/buildContextBatches.mjs
var qn = {};
N.handleByMap(x.ShapeBuilder, qn), N.add(In, Fn, Ln, wn, Tn, En);
var Jn = new e(), Yn = new I();
function Xn(e, t) {
	...
	for (let t = 0; t < e.instructions.length; t++) {
		...
		if (i.action === "texture") Zn(i.data, r, n);
		else if (i.action === "fill" || i.action === "stroke") {
			let e = i.action === "stroke", t = i.data.path.shapePath, a = i.data.style, o = i.data.hole;
			e && o && Qn(o.shapePath, a, !0, r, n), o && (t.shapePrimitives[t.shapePrimitives.length - 1].holes = o.shapePath.shapePrimitives), Qn(t, a, e, r, n);
		}
	}
}
function Zn(e, t, n) {
	let r = [], i = qn.rectangle, a = Jn;
	...
	o && xn(r, o), i.triangulate(r, c, 2, f, u, d);
...
function Qn(e, t, n, r, i) {
	let { vertices: a, uvs: c, indices: l } = i;
	e.shapePrimitives.forEach(({ shape: e, transform: u, holes: d }) => {
		let f = [], p = qn[e.type];
		if (!p.build(e, f)) return;
		let m = l.length, h = a.length / 2, g = "triangle-list";
		if (u && xn(f, u), n) {
			let n = e.closePath ?? !0, r = t;
			r.pixelLine ? (Mn(f, n, a, l), g = "line-list") : jn(f, r, !1, n, a, l);
		} else if (d) {
			let e = [], t = f.slice();
			$n(d).forEach((n) => {
				e.push(t.length / 2), t.push(...n);
			}), Nn(t, e, a, 2, h, l, m);
		} else p.triangulate(f, a, 2, h, l, m);
		let _ = c.length / 2, v = t.texture;
		if (v !== o.WHITE) {
			let n = Kn(Yn, t, e, u);
			yn(a, 2, h, c, _, 2, a.length / 2 - h, n);
		} else bn(c, _, 2, a.length / 2 - h);
		let y = s.get(Cn);
		y.indexOffset = m, y.indexSize = l.length - m, y.attributeOffset = h, y.attributeSize = a.length / 2 - h, y.baseColor = t.color, y.alpha = t.alpha, y.texture = v, y.geometryData = i, y.topology = g, r.push(y);
	});
}
function $n(e) {
	let t = [];
	for (let n = 0; n < e.length; n++) {
		let r = e[n].shape, i = [];
		qn[r.type].build(r, i) && t.push(i);
	}
	return t;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/GraphicsContextSystem.mjs
var er = class {
	constructor() {
	...
	constructor() {
		this.instructions = new i();
	}
	init(e) {
		let t = e.maxTextures;
		this.batcher ? this.batcher._updateMaxTextures(t) : this.batcher = new De({ maxTextures: t }), this.instructions.reset();
	}
	get geometry() {
		return _(v, "GraphicsContextRenderData#geometry is deprecated, please use batcher.geometry instead."), this.batcher.geometry;
	}
	destroy() {
	...
	_initContextRenderData(e) {
		let t = s.get(tr, { maxTextures: this._renderer.limits.maxBatchableTextures }), n = e._gpuData[this._renderer.uid], { batches: r, geometryData: i } = n;
		n.graphicsData = t;
		...
		for (let e = 0; e < u.length; e++) {
			let t = u[e];
			t.bindGroup = Ie(t.textures.textures, t.textures.count, this._renderer.limits.maxBatchableTextures);
		}
		return t;
	}
	_initContext(e) {
...
nr.extension = {
	...
	name: "graphicsContext"
}, nr.defaultOptions = { bezierSmoothness: .5 };
var rr = nr, ir = 8, ar = 1.1920929e-7, or = 1;
function sr(e, t, n, r, i, a, o, s, c, l) {
	let u = (or - Math.min(.99, Math.max(0, l ?? rr.defaultOptions.bezierSmoothness))) / 1;
	return u *= u, cr(t, n, r, i, a, o, s, c, e, u), e;
}
function cr(e, t, n, r, i, a, o, s, c, l) {
	lr(e, t, n, r, i, a, o, s, c, l, 0), c.push(o, s);
}
function lr(e, t, n, r, i, a, o, s, c, l, u) {
	...
	lr(e, t, d, f, _, v, x, S, c, l, u + 1), lr(x, S, y, b, h, g, o, s, c, l, u + 1);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildAdaptiveQuadratic.mjs
var ur = 8, dr = 1.1920929e-7, fr = 1;
function pr(e, t, n, r, i, a, o, s) {
	let c = (fr - Math.min(.99, Math.max(0, s ?? rr.defaultOptions.bezierSmoothness))) / 1;
	return c *= c, mr(t, n, r, i, a, o, e, c), e;
}
function mr(e, t, n, r, i, a, o, s) {
	hr(o, e, t, n, r, i, a, s, 0), o.push(i, a);
}
function hr(e, t, n, r, i, a, o, s, c) {
	...
	hr(e, t, n, l, u, p, m, s, c + 1), hr(e, p, m, d, f, a, o, s, c + 1);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildArc.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildArcTo.mjs
function _r(e, t, n, r, i, a) {
	...
	gr(e, y + t, b + n, a, T, E, c * l > u * s);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/buildCommands/buildArcToSvg.mjs
var vr = Math.PI * 2, yr = {
	centerX: 0,
	centerY: 0,
	ang1: 0,
	ang2: 0
}, br = ({ x: e, y: t }, n, r, i, a, o, s, c) => {
	e *= n, t *= r;
...
}, Cr = (e, t, n, r, i, a, o, s, c, l, u, d, f) => {
	let p = i ** 2, m = a ** 2, h = u ** 2, g = d ** 2, _ = p * m - p * g - m * h;
	_ < 0 && (_ = 0), _ /= p * g + m * h, _ = Math.sqrt(_) * (o === s ? -1 : 1);
	let v = _ * i / a * d, y = _ * -a / i * u, b = l * v - c * y + (e + n) / 2, x = c * v + l * y + (t + r) / 2, S = (u - v) / i, C = (d - y) / a, w = (-u - v) / i, T = (-d - y) / a, E = Sr(1, 0, S, C), D = Sr(S, C, w, T);
	s === 0 && D > 0 && (D -= vr), s === 1 && D < 0 && (D += vr), f.centerX = b, f.centerY = x, f.ang1 = E, f.ang2 = D;
};
function wr(e, t, n, r, i, a, o, s = 0, c = 0, l = 0) {
	if (a === 0 || o === 0) return;
	let u = Math.sin(s * vr / 360), d = Math.cos(s * vr / 360), f = d * (t - r) / 2 + u * (n - i) / 2, p = -u * (t - r) / 2 + d * (n - i) / 2;
	if (f === 0 && p === 0) return;
	a = Math.abs(a), o = Math.abs(o);
	let m = f ** 2 / a ** 2 + p ** 2 / o ** 2;
	m > 1 && (a *= Math.sqrt(m), o *= Math.sqrt(m)), Cr(t, n, r, i, a, o, c, l, u, d, f, p, yr);
	let { ang1: h, ang2: g } = yr, { centerX: _, centerY: v } = yr, y = Math.abs(g) / (vr / 4);
	...
	for (let t = 0; t < b; t++) {
		let t = xr(h, g), { x: n, y: r } = br(t[0], a, o, d, u, _, v, C), { x: i, y: s } = br(t[1], a, o, d, u, _, v, C), { x: c, y: l } = br(t[2], a, o, d, u, _, v, C);
		sr(e, x, S, n, r, i, s, c, l), x = c, S = l, h += g;
	}
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/path/roundShape.mjs
function Tr(e, t, n) {
	let r = (e, t) => {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/path/ShapePath.mjs
var Dr = new e(), Or = class {
	constructor(e) {
		this.shapePrimitives = [], this._currentPoly = null, this._bounds = new n(), this._graphicsPath2D = e, this.signed = e.checkForHoles;
	}
	moveTo(e, t) {
	...
	arc(e, t, n, r, i, a) {
		...
		return gr(o, e, t, n, r, i, a), this;
	}
	arcTo(e, t, n, r, i) {
		this._ensurePoly();
		let a = this._currentPoly.points;
		return _r(a, e, t, n, r, i), this;
	}
	arcToSvg(e, t, n, r, i, a, o) {
		let s = this._currentPoly.points;
		return wr(s, this._currentPoly.lastX, this._currentPoly.lastY, a, o, e, t, n, r, i), this;
	}
	bezierCurveTo(e, t, n, r, i, a, o) {
		this._ensurePoly();
		let s = this._currentPoly;
		return sr(this._currentPoly.points, s.lastX, s.lastY, e, t, n, r, i, a, o), this;
	}
	quadraticCurveTo(e, t, n, r, i) {
		this._ensurePoly();
		let a = this._currentPoly;
		return pr(this._currentPoly.points, a.lastX, a.lastY, e, t, n, r, i), this;
	}
	closePath() {
	...
	rect(t, n, r, i, a) {
		return this.drawShape(new e(t, n, r, i), a), this;
	}
	circle(e, t, n, r) {
		return this.drawShape(new un(e, t, n), r), this;
	}
	poly(e, t, n) {
		let r = new gn(e);
	...
	roundShape(e, t, n = !1, r) {
		return e.length < 3 ? this : (n ? Er(this, e, t, r) : Tr(this, e, t), this.closePath());
	}
	...
	ellipse(e, t, n, r, i) {
		return this.drawShape(new dn(e, t, n, r), i), this;
	}
	roundRect(e, t, n, r, i, a) {
		return this.drawShape(new vn(e, t, n, r, i), a), this;
	}
	drawShape(e, t) {
	...
	startPoly(e, t) {
		...
		return n && this.endPoly(), n = new gn(), n.points.push(e, t), this._currentPoly = n, this;
	}
	endPoly(e = !1) {
	...
	_ensurePoly(e = !0) {
		if (!this._currentPoly && (this._currentPoly = new gn(), e)) {
	...
	get bounds() {
		...
		for (let n = 0; n < t.length; n++) {
			let r = t[n], i = r.shape.getBounds(Dr);
	...
	constructor(e, t = !1) {
		this.instructions = [], this.uid = d("graphicsPath"), this._dirty = !0, this.checkForHoles = t, typeof e == "string" ? ln(e, this) : this.instructions = e?.slice() ?? [];
	}
	get shapePath() {
		return this._shapePath ||= new Or(this), this._dirty && (this._dirty = !1, this._shapePath.buildPath()), this._shapePath;
	}
	addPath(e, t) {
	...
	bezierCurveToShort(e, t, n, r, i) {
		let a = this.instructions[this.instructions.length - 1], o = this.getLastPoint(j.shared), s = 0, c = 0;
	...
	quadraticCurveToShort(e, t, n) {
		let r = this.instructions[this.instructions.length - 1], i = this.getLastPoint(j.shared), a = 0, o = 0;
	...
	transform(e) {
		...
		let t = e.a, n = e.b, r = e.c, i = e.d, a = e.tx, o = e.ty, s = 0, c = 0, l = 0, u = 0, d = 0, p = 0, m = 0, h = 0;
		for (let g = 0; g < this.instructions.length; g++) {
			...
			switch (_.action) {
				...
				case "lineTo":
					...
					break;
				case "bezierCurveTo":
					l = v[0], u = v[1], d = v[2], p = v[3], s = v[4], c = v[5], v[0] = t * l + r * u + a, v[1] = n * l + i * u + o, v[2] = t * d + r * p + a, v[3] = n * d + i * p + o, v[4] = t * s + r * c + a, v[5] = n * s + i * c + o;
					break;
				case "quadraticCurveTo":
					l = v[0], u = v[1], s = v[2], c = v[3], v[0] = t * l + r * u + a, v[1] = n * l + i * u + o, v[2] = t * s + r * c + a, v[3] = n * s + i * c + o;
					break;
				case "arcToSvg":
					s = v[5], c = v[6], m = v[0], h = v[1], v[0] = t * m + r * h, v[1] = n * m + i * h, v[5] = t * s + r * c + a, v[6] = n * s + i * c + o;
					break;
				case "circle":
					v[4] = Ar(v[3], e);
					break;
				...
				default: f("unknown transform action", _.action);
			}
		}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/svg/parseSVGFloatAttribute.mjs
function K(e, t, n) {
	let r = e.getAttribute(t);
	return r ? Number(r) : n;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/svg/parseSVGDefinitions.mjs
function jr(e, t) {
		...
		for (let e = 0; e < r.children.length; e++) {
			...
			switch (n.nodeName.toLowerCase()) {
				case "lineargradient":
					t.defs[n.id] = Mr(n);
					break;
				case "radialgradient": t.defs[n.id] = Nr(n);
			}
		}
	}
}
function Mr(e) {
	let t = new G(K(e, "x1", 0), K(e, "y1", 0), K(e, "x2", 1), K(e, "y2", 0), (e.getAttribute("gradientUnits") || "objectBoundingBox") === "objectBoundingBox" ? "local" : "global");
	for (let n = 0; n < e.children.length; n++) {
		let r = e.children[n], i = K(r, "offset", 0), a = R.shared.setValue(r.getAttribute("stop-color")).toNumber();
		t.addColorStop(i, a);
	}
	return t;
}
function Nr(e) {
	return f("[SVG Parser] Radial gradients are not yet supported"), new G(0, 0, 1, 0);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/svg/utils/extractSvgUrlId.mjs
function Pr(e) {
	let t = e.match(/url\s*\(\s*['"]?\s*#([^'"\s)]+)\s*['"]?\s*\)/i);
	return t ? t[1] : "";
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/svg/parseSVGStyle.mjs
var Fr = {
	fill: {
		type: "paint",
		default: 0
	...
	switch (n) {
		case "stroke":
			if (r !== "none") {
				...
				} else t.strokeStyle.color = R.shared.setValue(r).toNumber();
				t.useStroke = !0;
			}
			break;
		case "stroke-width":
		...
		case "fill":
			if (r !== "none") {
				...
				} else t.fillStyle.color = R.shared.setValue(r).toNumber();
				t.useFill = !0;
			}
			break;
		case "fill-opacity":
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/svg/utils/fillOperations.mjs
function Rr(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/svg/utils/pathOperations.mjs
function zr(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/svg/SVGParser.mjs
function Hr(e, t) {
	if (typeof e == "string") {
	...
	jr(e, n);
	let r = e.children, { fillStyle: i, strokeStyle: a } = Ir(e, n);
	for (let e = 0; e < r.length; e++) {
		let t = r[e];
		t.nodeName.toLowerCase() !== "defs" && Ur(t, n, i, a);
	}
	return t;
}
function Ur(e, t, n, r) {
	let i = e.children, { fillStyle: a, strokeStyle: o } = Ir(e, t);
	a && n ? n = {
		...n,
		...a
	} : a && (n = a), o && r ? r = {
	...
	let s = !n && !r;
	s && (n = { color: 0 });
	let c, l, u, d, p, m, h, g, _, v, y, b, x, S, C, w, T;
	switch (e.nodeName.toLowerCase()) {
		case "path": {
			S = e.getAttribute("d");
			let i = e.getAttribute("fill-rule"), a = zr(S), o = i === "evenodd", s = a.length > 1;
			if (o && s) {
				let e = a.map((e) => ({
					path: e,
					area: Br(e)
				}));
				if (e.sort((e, t) => t.area - e.area), a.length > 3 || !Rr(e)) for (let i = 0; i < e.length; i++) {
					let a = e[i], o = i === 0;
					t.context.beginPath();
					let s = new kr(void 0, !0);
					Vr(a.path, s), t.context.path(s), o ? (n && t.context.fill(n), r && t.context.stroke(r)) : t.context.cut();
				}
				else for (let i = 0; i < e.length; i++) {
					let a = e[i], o = i % 2 == 1;
					t.context.beginPath();
					let s = new kr(void 0, !0);
					Vr(a.path, s), t.context.path(s), o ? t.context.cut() : (n && t.context.fill(n), r && t.context.stroke(r));
				}
			} else C = new kr(S, !i || i === "evenodd"), t.context.path(C), n && t.context.fill(n), r && t.context.stroke(r);
			break;
		}
		case "circle":
			h = K(e, "cx", 0), g = K(e, "cy", 0), _ = K(e, "r", 0), t.context.ellipse(h, g, _, _), n && t.context.fill(n), r && t.context.stroke(r);
			break;
		case "rect":
			c = K(e, "x", 0), l = K(e, "y", 0), w = K(e, "width", 0), T = K(e, "height", 0), v = K(e, "rx", 0), y = K(e, "ry", 0), v || y ? t.context.roundRect(c, l, w, T, v || y) : t.context.rect(c, l, w, T), n && t.context.fill(n), r && t.context.stroke(r);
			break;
		case "ellipse":
			h = K(e, "cx", 0), g = K(e, "cy", 0), v = K(e, "rx", 0), y = K(e, "ry", 0), t.context.beginPath(), t.context.ellipse(h, g, v, y), n && t.context.fill(n), r && t.context.stroke(r);
			break;
		case "line":
			u = K(e, "x1", 0), d = K(e, "y1", 0), p = K(e, "x2", 0), m = K(e, "y2", 0), t.context.beginPath(), t.context.moveTo(u, d), t.context.lineTo(p, m), r && t.context.stroke(r);
			break;
		case "polygon":
		...
		case "g":
		case "svg": break;
		default: f(`[SVG parser] <${e.nodeName}> elements unsupported`);
	}
	s && (n = null);
	for (let e = 0; e < i.length; e++) Ur(i[e], t, n, r);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/fill/FillPattern.mjs
function Wr(e) {
...
var Gr = {
	...
	constructor(e, t) {
		this.uid = d("fillPattern"), this._tick = 0, this.transform = new I();
		let n = Wr(e) ? e : {
			texture: e,
			repetition: t
		};
		...
		let r = n.repetition;
		r && (this.texture.source.style.addressModeU = Gr[r].addressModeU, this.texture.source.style.addressModeV = Gr[r].addressModeV);
	}
	setTransform(e) {
		if (e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/utils/convertFillInputToFillStyle.mjs
function qr(e) {
	return R.isColorLike(e);
}
function Jr(e) {
...
function Zr(e, t, n) {
	let r = R.shared.setValue(t ?? 0);
	return e.color = r.toNumber(), e.alpha = r.alpha === 1 ? n.alpha : r.alpha, e.texture = o.WHITE, {
		...n,
		...e
	};
}
...
function ti(e, t) {
	let n = {
		...t,
		...e
	}, r = R.shared.setValue(n.color);
	return n.alpha *= r.alpha, n.color = r.toNumber(), n;
}
function ni(e, t) {
	if (e == null) return null;
	let n = {}, r = e;
	return qr(e) ? Zr(n, e, t) : Xr(e) ? Qr(n, e, t) : Jr(e) ? $r(n, e, t) : Yr(e) ? ei(n, e, t) : r.fill && Jr(r.fill) ? $r(r, r.fill, t) : r.fill && Yr(r.fill) ? ei(r, r.fill, t) : ti(r, t);
}
function ri(e, t) {
	let { width: n, alignment: r, miterLimit: i, cap: a, join: o, pixelLine: s, ...c } = t, l = ni(e, c);
	return l ? {
		width: n,
		alignment: r,
		miterLimit: i,
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/utils/getMaxMiterRatio.mjs
function ii(e, t) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/GraphicsContext.mjs
var ai = new j(), oi = new I(), si = class e extends te {
	constructor() {
		super(...arguments), this._gpuData = /* @__PURE__ */ Object.create(null), this.autoGarbageCollect = !0, this._gcLastUsed = -1, this.uid = d("graphicsContext"), this.dirty = !0, this.batchMode = "auto", this.instructions = [], this.destroyed = !1, this._activePath = new kr(), this._transform = new I(), this._fillStyle = { ...e.defaultFillStyle }, this._strokeStyle = { ...e.defaultStrokeStyle }, this._stateStack = [], this._tick = 0, this._bounds = new n(), this._boundsDirty = !0;
	}
	clone() {
		let t = new e();
	...
	set fillStyle(t) {
		this._fillStyle = ni(t, e.defaultFillStyle);
	}
	get strokeStyle() {
		return this._strokeStyle;
	}
	set strokeStyle(t) {
		this._strokeStyle = ri(t, e.defaultStrokeStyle);
	}
	setFillStyle(t) {
		return this._fillStyle = ni(t, e.defaultFillStyle), this;
	}
	setStrokeStyle(t) {
		return this._strokeStyle = ni(t, e.defaultStrokeStyle), this;
	}
	texture(e, t, n, r, i, a) {
		return this.instructions.push({
			action: "texture",
			data: {
				...
				style: t || t === 0 ? R.shared.setValue(t).toNumber() : 16777215
			}
		}), this.onUpdate(), this;
	}
	beginPath() {
		return this._activePath = new kr(), this;
	}
	fill(t, n) {
		let r, i = this.instructions[this.instructions.length - 1];
		return r = this._tick === 0 && i?.action === "stroke" ? i.data.path : this._activePath.clone(), r ? (t != null && (n !== void 0 && typeof t == "number" && (_(g, "GraphicsContext.fill(color, alpha) is deprecated, use GraphicsContext.fill({ color, alpha }) instead"), t = {
			color: t,
			alpha: n
		}), this._fillStyle = ni(t, e.defaultFillStyle)), this.instructions.push({
			action: "fill",
			data: {
	...
	_initNextPathLocation() {
		let { x: e, y: t } = this._activePath.getLastPoint(j.shared);
		this._activePath.clear(), this._activePath.moveTo(e, t);
	}
	stroke(t) {
		let n, r = this.instructions[this.instructions.length - 1];
		return n = this._tick === 0 && r?.action === "fill" ? r.data.path : this._activePath.clone(), n ? (t != null && (this._strokeStyle = ri(t, e.defaultStrokeStyle)), this.instructions.push({
			action: "stroke",
			data: {
	...
	svg(e) {
		return this._tick++, Hr(e, this), this;
	}
	restore() {
	...
	setTransform(e, t, n, r, i, a) {
		return e instanceof I ? (this._transform.set(e.a, e.b, e.c, e.d, e.tx, e.ty), this) : (this._transform.set(e, t, n, r, i, a), this);
	}
	transform(e, t, n, r, i, a) {
		return e instanceof I ? (this._transform.append(e), this) : (oi.set(e, t, n, r, i, a), this._transform.append(oi), this);
	}
	translate(e, t = e) {
	...
	get bounds() {
		...
		for (let t = 0; t < this.instructions.length; t++) {
			...
			if (r === "stroke") {
				...
				t.style.join === "miter" && (i *= ii(t.path, t.style.miterLimit));
				let a = t.path.bounds;
	...
	containsPoint(e) {
		...
		for (let r = 0; r < t.length; r++) {
			...
			for (let t = 0; t < c.length; t++) {
				let r = c[t].shape;
				if (!s || !r) continue;
				let o = c[t].transform, l = o ? o.applyInverse(e, ai) : e;
...
var q = si, ci = class {
	...
	_initContextRenderData(e) {
		let t = new li(), n = this.getGpuContext(e);
...
ui.extension = {
	type: [x.CanvasSystem],
	name: "graphicsContext"
}, ui.defaultOptions = { bezierSmoothness: .5 };
var di = ui, fi = class {
	constructor(e, t) {
		this.state = M.for2d(), this.renderer = e, this._adaptor = t, this.renderer.runners.contextChange.add(this), this._managedGraphics = new V({
			renderer: e,
			type: "renderable",
			priority: -1,
			name: "graphics"
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/GraphicsPipe.mjs
var pi = class {
	constructor() {
	...
	execute(e) {
		...
		i.uTransformMatrix = e.groupTransform, i.uRound = t._roundPixels | e._roundPixels, ye(e.groupColorAlpha, i.uColor, 0), this._adaptor.execute(this, e);
	}
	_rebuild(e) {
...
mi.extension = {
	...
	name: "graphics"
}, N.add(fi), N.add(mi), N.add(di), N.add(rr);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/shared/Graphics.mjs
var J = class e extends p {
	constructor(e) {
	...
	lineStyle(e, t, n) {
		_(g, "Graphics#lineStyle is no longer needed. Use Graphics#setStrokeStyle to set the stroke style.");
		let r = {};
		return e && (r.width = e), t && (r.color = t), n && (r.alpha = n), this.context.strokeStyle = r, this;
	}
	beginFill(e, t) {
		_(g, "Graphics#beginFill is no longer needed. Use Graphics#fill to fill the shape with the desired style.");
		let n = {};
		return e !== void 0 && (n.color = e), t !== void 0 && (n.alpha = t), this.context.fillStyle = n, this;
	}
	endFill() {
		_(g, "Graphics#endFill is no longer needed. Use Graphics#fill to fill the shape with the desired style."), this.context.fill();
	...
	drawCircle(...e) {
		return _(g, "Graphics#drawCircle has been renamed to Graphics#circle"), this._callContextMethod("circle", e);
	}
	drawEllipse(...e) {
		return _(g, "Graphics#drawEllipse has been renamed to Graphics#ellipse"), this._callContextMethod("ellipse", e);
	}
	drawPolygon(...e) {
		return _(g, "Graphics#drawPolygon has been renamed to Graphics#poly"), this._callContextMethod("poly", e);
	}
	drawRect(...e) {
		return _(g, "Graphics#drawRect has been renamed to Graphics#rect"), this._callContextMethod("rect", e);
	}
	drawRoundedRect(...e) {
		return _(g, "Graphics#drawRoundedRect has been renamed to Graphics#roundRect"), this._callContextMethod("roundRect", e);
	}
	drawStar(...e) {
		return _(g, "Graphics#drawStar has been renamed to Graphics#star"), this._callContextMethod("star", e);
	}
}, hi = class extends p {
	constructor(e, t) {
		let { text: n, resolution: r, style: i, anchor: a, width: o, height: s, roundPixels: c, ...l } = e;
		super({ ...l }), this.batched = !0, this._resolution = null, this._autoResolution = !0, this._didTextUpdate = !0, this._styleClass = t, this.text = n ?? "", this.style = i, this.resolution = r ?? null, this.allowChildren = !1, this._anchor = new D({ _onUpdate: () => {
			this.onViewUpdate();
...
function gi(e, t) {
	let n = e[0] ?? {};
	return (typeof n == "string" || e[1]) && (_(g, `use new ${t}({ text: "hi!", style }) instead`), n = {
		text: n,
		style: e[1]
	}), n;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/utils/canvas/getCanvasBoundingBox.mjs
var _i = null, vi = null;
function yi(e, t) {
	_i || (_i = S.get().createCanvas(256, 128), vi = _i.getContext("2d", { willReadFrequently: !0 }), vi.globalCompositeOperation = "copy", vi.globalAlpha = 1), (_i.width < e || _i.height < t) && (_i.width = c(e), _i.height = c(t));
}
function bi(e, t, n) {
...
function Si(...t) {
	...
	let { canvas: r } = n, i = Math.min(n.resolution ?? 1, 1), a = n.width ?? r.width, o = n.height ?? r.height, s = n.output;
	if (yi(a, o), !vi) throw TypeError("Failed to get canvas 2D context");
	vi.drawImage(r, 0, 0, a, o, 0, 0, a * i, o * i);
	let c = vi.getImageData(0, 0, a, o).data, l = 0, u = 0, d = a - 1, f = o - 1;
	for (; u < o && bi(c, a, u);) ++u;
	if (u === o) return e.EMPTY;
	for (; bi(c, a, f);) --f;
	for (; xi(c, a, l, u, f);) ++l;
	for (; xi(c, a, d, u, f);) --d;
	return ++d, ++f, vi.globalCompositeOperation = "source-over", vi.strokeRect(l, u, d - l, f - u), vi.globalCompositeOperation = "copy", s ??= new e(), s.set(l / i, u / i, (d - l) / i, (f - u) / i), s;
}
//#endregion
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/text/canvas/utils/parseTaggedText.mjs
function Ti(e) {
...
var ki = /* @__PURE__ */ new Set([10, 13]), Ai = /* @__PURE__ */ new Set([
	9,
	32,
	8192,
	8193,
...
function Pi(e) {
	return typeof e == "string" && ki.has(e.charCodeAt(0));
}
function Y(e, t) {
	return typeof e == "string" && Ai.has(e.charCodeAt(0));
}
function Fi(e) {
	return typeof e == "string" && ji.has(e.charCodeAt(0));
}
function Ii(e) {
...
function zi(e) {
	...
	for (let r = 0; r < e.length; r++) {
		...
		n.push(i), Fi(i) && a && !Y(a) && !Pi(a) && (t.push(n.join("")), n.length = 0);
	}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/text/canvas/utils/measureTaggedText.mjs
var Vi = /\r\n|\r|\n/g;
function Hi(e, t, n, r, i, a, o, s, c) {
	let l = Oi(e, t);
	if (Li(t.whiteSpace)) for (let e = 0; e < l.length; e++) {
		let t = l[e];
		l[e] = {
			text: t.text.replace(Vi, " "),
			style: t.style
		};
	}
	let u = [], d = [];
	for (let e of l) {
		let t = e.text.split(Mi);
		for (let n = 0; n < t.length; n++) {
			let r = t[n];
	...
	let f = n ? Ui(u, t, r, a, s, c) : u, p = [], m = [], h = [], g = [], _ = [], v = 0, y = t._fontString, b = o(y);
...
function Ui(e, t, n, r, i, a) {
	let { letterSpacing: o, whiteSpace: s, wordWrapWidth: c, breakWords: l } = t, u = Ii(s), d = c + o, f = {}, p = "", m = (e, t) => {
	...
	for (let t of e) {
		let e = Wi(t), n = h.length, r = (t) => {
			...
			if (g(), s.length > 0) {
				let e = s[s.length - 1];
				e.text = Ri(e.text), e.text.length === 0 && s.pop();
			}
			h.push(s), s = [], c = 0, f = !1;
		};
		for (let t = 0; t < e.length; t++) {
			...
			if (u) {
				let e = Y(n), t = p?.text[p.text.length - 1] ?? s[s.length - 1]?.text.slice(-1) ?? "", r = t ? Y(t) : !1;
				if (e && r) continue;
			}
			let x = !y, S = x ? r(t) : b;
			if (S > d && x) {
				if (c > 0 && _(), l) {
					let e = o(t);
					for (let t = 0; t < e.length; t++) {
						let n = e[t].token, r = e[t].style, o = Bi(n, l, a, i);
						for (let e of o) {
							let t = m(e, r);
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/text/canvas/utils/wordWrap.mjs
var Gi = { willReadFrequently: !0 };
function Ki(e, t, n, r, i) {
	let a = n[e];
	return typeof a != "number" && (a = i(e, t, r) + t, n[e] = a), a;
}
function qi(e, t, n, r, i, a, o) {
	let s = n.getContext("2d", Gi);
	s.font = t._fontString;
	let c = 0, l = "", u = [], d = /* @__PURE__ */ Object.create(null), { letterSpacing: f, whiteSpace: p } = t, m = Ii(p), h = Li(p), g = !m, _ = t.wordWrapWidth + f, v = zi(e);
	for (let e = 0; e < v.length; e++) {
		let n = v[e];
		if (Pi(n)) {
			if (!h) {
				u.push(Ri(l)), g = !m, l = "", c = 0;
				continue;
			}
			n = " ";
		}
		if (m) {
			let e = Y(n), t = Y(l[l.length - 1]);
			if (e && t) continue;
		}
		let p = Ki(n, f, d, s, r);
		if (p > _) {
			if (l !== "" && (u.push(Ri(l)), l = "", c = 0), i(n, t.breakWords)) {
				let e = Bi(n, t.breakWords, o, a);
				for (let t of e) {
					let e = Ki(t, f, d, s, r);
					e + c > _ && (u.push(Ri(l)), g = !1, l = "", c = 0), l += t, c += e;
				}
			} else l.length > 0 && (u.push(Ri(l)), l = "", c = 0), u.push(Ri(n)), g = !1, l = "", c = 0;
		} else p + c > _ && (g = !1, u.push(Ri(l)), l = "", c = 0), (l.length > 0 || !Y(n) || g) && (l += n, c += p);
	}
	let y = Ri(l);
	return y.length > 0 && u.push(y), u.join("\n");
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/text/canvas/CanvasTextMetrics.mjs
var Ji = { willReadFrequently: !0 }, Yi = class e {
	static get experimentalLetterSpacingSupported() {
		let t = e._experimentalLetterSpacingSupported;
		if (t === void 0) {
			let n = S.get().getCanvasRenderingContext2D().prototype;
	...
	static measureText(t = " ", n, r = e._canvas, i = n.wordWrap) {
		...
		if (Ti(n) && Ei(t)) {
			let r = Hi(t, n, i, e._context, e._measureText, e._measureTextAdvance, e.measureFont, e.canBreakChars, e.wordWrapSplit), o = new e(t, n, r.width, r.height, r.lines, r.lineWidths, r.lineHeight, r.maxLineWidth, r.fontProperties, {
		...
		let c = e._context;
		c.font = o;
		let l = (i ? e._wordWrap(t, n, r) : t).split(Ni), u = Array(l.length), d = 0;
	...
	static get _canvas() {
		if (!e.__canvas) {
			...
			try {
				...
				if (n.getContext("2d", Ji)?.measureText) return e.__canvas = n, n;
				t = S.get().createCanvas();
			} catch {
				t = S.get().createCanvas();
			}
	...
	static get _context() {
		return e.__context ||= e._canvas.getContext("2d", Ji), e.__context;
	}
};
Yi.METRICS_STRING = "|ÉqÅ", Yi.BASELINE_SYMBOL = "M", Yi.BASELINE_MULTIPLIER = 1.4, Yi.HEIGHT_MULTIPLIER = 2, Yi.graphemeSegmenter = (() => {
	...
	return (e) => [...e];
})(), Yi.experimentalLetterSpacing = !1, Yi._fonts = {}, Yi._measurementCache = wi(1e3);
var Xi = Yi, Zi = [
	"serif",
	"sans-serif",
	"monospace",
...
function Qi(e) {
	...
	for (let e = n.length - 1; e >= 0; e--) {
		let t = n[e].trim();
		!/([\"\'])[^\'\"]+\1/.test(t) && !Zi.includes(t) && (t = `"${t}"`), n[e] = t;
	}
	return `${e.fontStyle} ${e.fontVariant} ${e.fontWeight} ${t} ${n.join(",")}`;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/text/canvas/utils/getCanvasFillStyle.mjs
var $i = 1e5;
function ea(e, t, n, r = 0, i = 0, a = 0) {
	if (e.texture === o.WHITE && !e.fill) return R.shared.setValue(e.color).setAlpha(e.alpha ?? 1).toHexa();
	if (!e.fill) {
	...
	if (e.fill instanceof Kr) {
		let n = e.fill, r = t.createPattern(n.texture.source.resource, "repeat");
		return z.applyPatternTransform(r, n.transform, !1), r;
	}
		...
		if (f && c && n) {
			...
			for (let t = 0; t < n.lines.length; t++) {
				...
				o.colorStops.forEach((t) => {
					let n = i + t.offset * e;
					n = Math.max(0, Math.min(1, n)), d.addColorStop(Math.floor(n * $i) / $i, R.shared.setValue(t.color).toHex());
				});
			}
		} else o.colorStops.forEach((e) => {
			d.addColorStop(e.offset, R.shared.setValue(e.color).toHex());
		});
		return d;
	}
	return f("FillStyle not recognised", e), "red";
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/text/canvas/CanvasTextGenerator.mjs
var ta = new e();
function na(e) {
	let t = 0;
...
var ra = new class {
	getCanvasAndContext(e) {
		let { text: t, style: n, resolution: r = 1 } = e, i = n._getFinalPadding(), a = Xi.measureText(t || " ", n), o = Math.ceil(Math.ceil(Math.max(1, a.width) + i * 2) * r), s = Math.ceil(Math.ceil(Math.max(1, a.height) + i * 2) * r), c = Le.getOptimalCanvasAndContext(o, s);
	...
	_renderTextToCanvas(e, t, n, r, i) {
		...
		let { canvas: a, context: o } = r, s = Qi(e), c = i.lines, l = i.lineHeight, u = i.lineWidths, d = i.maxLineWidth, f = i.fontProperties, p = a.height;
	...
	_renderTaggedTextToCanvas(e, t, n, r, i) {
		...
		for (let e = 0; e < s.length; e++) {
			...
			for (let e of t) {
				let t = Qi(e.style);
				o.font = t, n.push({
					width: Xi._measureText(e.text, e.style.letterSpacing, o),
					font: t
				});
			}
			_.push(n);
				...
				for (let e = 0; e < f.length; e++) {
					...
					if (o.font = c, o.textBaseline = t.style.textBaseline, t.style._stroke?.width) {
						...
						if (o.lineWidth = e.width, o.miterLimit = e.miterLimit, o.lineJoin = e.join, o.lineCap = e.cap, a) {
							...
							let r = Xi.measureFont(c), i = t.style.lineHeight || r.fontSize;
							o.strokeStyle = ea(e, o, {
								width: s,
								height: i,
								lineHeight: i,
								lines: [t.text]
				...
				for (let e = 0; e < f.length; e++) {
					...
					if (o.font = c, o.textBaseline = t.style.textBaseline, t.style._fill !== void 0) {
						if (a) {
							...
							let e = Xi.measureFont(c), r = t.style.lineHeight || e.fontSize, i = {
								width: s,
								height: r,
								lineHeight: r,
								lines: [t.text]
							};
							o.fillStyle = ea(t.style._fill, o, i, n * 2, T - n, v);
						}
	...
	_setFillAndStrokeStyles(e, t, n, r, i, a = 0, o = 0) {
		if (e.fillStyle = t._fill ? ea(t._fill, e, n, r * 2, a, o) : null, t._stroke?.width) {
			let s = i + r * 2;
			e.strokeStyle = ea(t._stroke, e, n, s, a, o);
		}
	}
	_setupDropShadow(e, t, n, r) {
		e.fillStyle = "black", e.strokeStyle = "black";
		let i = t.dropShadow, a = i.color, o = i.alpha;
		e.shadowColor = R.shared.setValue(a).setAlpha(o).toRgbaString();
	...
	_drawLetterSpacing(e, t, n, r, i, a = !1, o = 0) {
		...
		if (Xi.experimentalLetterSpacingSupported && (Xi.experimentalLetterSpacing ? (s.letterSpacing = `${c}px`, s.textLetterSpacing = `${c}px`, l = !0) : (s.letterSpacing = "0px", s.textLetterSpacing = "0px")), (c === 0 || l) && o === 0) {
		...
		let u = r, d = Xi.graphemeSegmenter(e), f = s.measureText(e).width, p = 0;
...
}(), ia = class e extends te {
	constructor(t = {}) {
		super(), this.uid = d("textStyle"), this._tick = 0, this._cachedFontString = null, oa(t), t instanceof e && (t = t._toObject());
		let n = {
			...e.defaultTextStyle,
			...t
		};
	...
	set fill(e) {
		e !== this._originalFill && (this._originalFill = e, this._isFillStyle(e) && (this._originalFill = this._createProxy({
			...
			this._fill = ni({ ...this._originalFill }, q.defaultFillStyle);
		})), this._fill = ni(e === 0 ? "black" : e, q.defaultFillStyle), this.update());
	}
	get stroke() {
	...
	set stroke(e) {
		e !== this._originalStroke && (this._originalStroke = e, this._isFillStyle(e) && (this._originalStroke = this._createProxy({
			...
			this._stroke = ri({ ...this._originalStroke }, q.defaultStrokeStyle);
		})), this._stroke = ri(e, q.defaultStrokeStyle), this.update());
	}
	get tagStyles() {
	...
	get _fontString() {
		return this._cachedFontString === null && (this._cachedFontString = Qi(this)), this._cachedFontString;
	}
	_toObject() {
		return {
			align: this.align,
	...
	_isFillStyle(e) {
		return (e ?? null) !== null && !(R.isColorLike(e) || e instanceof G || e instanceof Kr);
	}
};
...
function oa(e) {
	...
	if (t.strokeThickness !== void 0) {
		_(g, "strokeThickness is now a part of stroke");
		let n = t.stroke, r = {};
		if (R.isColorLike(n)) r.color = n;
		else if (n instanceof G || n instanceof Kr) r.fill = n;
	...
	if (Array.isArray(t.fillGradientStops)) {
		if (_(g, "gradient fill is now a fill pattern: `new FillGradient(...)`"), !Array.isArray(t.fill) || t.fill.length === 0) throw Error("Invalid fill value. Expected an array of colors for gradient fill.");
		t.fill.length !== t.fillGradientStops.length && f("The number of fill colors must match the number of fill gradient stops.");
		let n = new G({
			start: {
				x: 0,
				y: 0
			...
			textureSpace: "local"
		}), r = t.fillGradientStops.slice(), i = t.fill.map((e) => R.shared.setValue(e).toNumber());
		r.forEach((e, t) => {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/text/utils/updateTextBounds.mjs
function sa(e, t) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/text/canvas/BatchableText.mjs
var ca = class extends je {}, la = class {
	constructor(e) {
		this._renderer = e, e.runners.resolutionChange.add(this), this._managedTexts = new V({
			renderer: e,
			type: "renderable",
	...
	addRenderable(e, t) {
		...
		if (e._didTextUpdate) {
			...
			(n.currentKey !== e.styleKey || e._resolution !== t) && this._updateGpuText(e), e._didTextUpdate = !1, sa(n, e);
		}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/text/shared/AbstractTextSystem.mjs
var ua = class {
	constructor(e, t) {
		this._activeTextures = {}, this._renderer = e, this._retainCanvasContext = t;
	}
	getTexture(e, t, n, r) {
		typeof e == "string" && (_("8.0.0", "CanvasTextSystem.getTexture: Use object TextOptions instead of separate arguments"), e = {
			text: e,
			style: n,
			resolution: t
		}), e.style instanceof aa || (e.style = new aa(e.style)), e.textureStyle instanceof l || (e.textureStyle = new l(e.textureStyle)), typeof e.text != "string" && (e.text = e.text.toString());
		let { text: i, style: a, textureStyle: o, autoGenerateMipmaps: s } = e, c = e.resolution ?? this._renderer.resolution, { frame: u, canvasAndContext: d } = ra.getCanvasAndContext({
			text: i,
			style: a,
			resolution: c
		}), f = se(d.canvas, u.width, u.height, c, s);
		if (o && (f.source.style = o), a.trim && (u.pad(a.padding), f.frame.copyFrom(u), f.frame.scale(1 / c), f.updateUvs()), a.filters) {
			let e = this._applyFilters(f, a.filters);
			return this.returnTexture(f), ra.returnCanvasAndContext(d), e;
		}
		return this._renderer.texture.initSource(f._source), this._retainCanvasContext || ra.returnCanvasAndContext(d), f;
	}
	returnTexture(e) {
		let t = e.source, n = t.resource;
		if (this._retainCanvasContext && n?.getContext) {
			let e = n.getContext("2d");
			e && ra.returnCanvasAndContext({
				canvas: n,
				context: e
			});
		}
		t.resource = null, t.uploadMethodId = "unknown", t.alphaMode = "no-premultiply-alpha", m.returnTexture(e, !0);
	}
	renderTextToCanvas() {
		_("8.10.0", "CanvasTextSystem.renderTextToCanvas: no longer supported, use CanvasTextSystem.getTexture instead");
	}
	getManagedTexture(e) {
	...
	_applyFilters(e, t) {
		...
		return this._renderer.renderTarget.bind({
			target: n,
			clear: !1
		}), r;
	}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/text/shared/GpuTextSystem.mjs
...
fa.extension = {
	type: [x.WebGLSystem, x.WebGPUSystem],
	name: "canvasText"
}, N.add(da), N.add(fa), N.add(la);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/text/Text.mjs
var pa = class extends hi {
	constructor(...e) {
		let t = gi(e, "Text");
		super(t, aa), this.renderPipeId = "text", t.textureStyle && (this.textureStyle = t.textureStyle instanceof l ? t.textureStyle : new l(t.textureStyle)), this.autoGenerateMipmaps = t.autoGenerateMipmaps ?? a.defaultOptions.autoGenerateMipmaps;
	}
	updateBounds() {
		let e = this._bounds, t = this._anchor, n = 0, r = 0;
		if (this._style.trim) {
			let { frame: e, canvasAndContext: t } = ra.getCanvasAndContext({
				text: this.text,
				style: this._style,
				resolution: 1
			});
			ra.returnCanvasAndContext(t), n = e.width, r = e.height;
		} else {
			let e = Xi.measureText(this._text, this._style);
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/utils/browser/isSafari.mjs
function ma() {
	let { userAgent: e } = S.get().getNavigator();
	return /^((?!chrome|android).)*safari/i.test(e);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/batcher/canvas/CanvasBatchAdaptor.mjs
var ha = class e {
	...
	execute(n, r) {
		...
		let a = n.renderer, o = a.canvasContext, s = o.activeContext;
		for (let n = 0; n < i.length; n++) {
			let c = i[n];
			if (!c.packAsQuad) continue;
			let l = c, d = l.texture, f = d ? z.getCanvasSource(d) : null;
			if (!f) continue;
			...
			if (x <= 0) continue;
			s.globalAlpha = x;
			let S = g & 16777215, C = _ & 16777215, w = u(t(C, S)), E = d.frame, D = p.addressModeU ?? p.addressMode, O = p.addressModeV ?? p.addressMode, k = e._getPatternRepeat(D, O), A = d.source._resolution ?? d.source.resolution ?? 1, j = l.renderable?.renderGroup?.isCachedAsTexture, M = E.x * A, N = E.y * A, P = E.width * A, ee = E.height * A, F = l.bounds, te = a.renderTarget.renderTarget.isRoot, ne = F.minX, re = F.minY, ie = F.maxX - F.minX, I = F.maxY - F.minY, ae = d.rotate, L = d.uvs, oe = Math.min(L.x0, L.x1, L.x2, L.x3, L.y0, L.y1, L.y2, L.y3), R = Math.max(L.x0, L.x1, L.x2, L.x3, L.y0, L.y1, L.y2, L.y3), se = k !== "no-repeat" && (oe < 0 || R > 1), ce = ae && !(!se && (w !== 16777215 || ae));
			ce ? (e._tempPatternMatrix.copyFrom(l.transform), T.matrixAppendRotationInv(e._tempPatternMatrix, ae, ne, re, ie, I), o.setContextTransform(e._tempPatternMatrix, l.roundPixels === 1, void 0, j && te)) : o.setContextTransform(l.transform, l.roundPixels === 1, void 0, j && te);
			let le = ie, ue = I, de = ce ? 0 : ne, fe = ce ? 0 : re;
			if (!ce && l.roundPixels === 1 && (de |= 0, fe |= 0), se) {
				let t = f, n = w !== 16777215 && !ae, r = E.width <= d.source.width && E.height <= d.source.height;
				n && r && (t = z.getTintedCanvas({ texture: d }, w));
				let i = s.createPattern(t, k);
				if (!i) continue;
				let a = le, o = ue;
				if (a === 0 || o === 0) continue;
				let c = 1 / a, l = 1 / o, u = (L.x1 - L.x0) * c, p = (L.y1 - L.y0) * c, m = (L.x3 - L.x0) * l, h = (L.y3 - L.y0) * l, g = L.x0 - u * de - m * fe, _ = L.y0 - p * de - h * fe, v = d.source.pixelWidth, y = d.source.pixelHeight;
				e._tempPatternMatrix.set(u * v, p * y, m * v, h * y, g * v, _ * y), z.applyPatternTransform(i, e._tempPatternMatrix), s.fillStyle = i, s.fillRect(de, fe, le, ue);
			} else {
				let e = w !== 16777215 || ae ? z.getTintedCanvas({ texture: d }, w) : f, t = e !== f;
				s.drawImage(e, t ? 0 : M, t ? 0 : N, t ? e.width : P, t ? e.height : ee, de, fe, le, ue);
			}
		}
	}
};
ha._tempPatternMatrix = new I(), ha.extension = {
	type: [x.CanvasPipesAdaptor],
	name: "batch"
};
var ga = ha, _a = class {
	constructor() {
		this._tempState = M.for2d(), this._didUploadHash = {};
	}
	init(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/batcher/gpu/GpuBatchAdaptor.mjs
var va = M.for2d(), ya = class {
	start(e, t, n) {
		let r = e.renderer, i = r.encoder, a = n.gpuProgram;
		this._shader = n, this._geometry = t, i.setGeometry(t, a), va.blendMode = "normal", r.pipeline.getPipeline(t, a, va, void 0, n._overrides);
	...
	execute(e, t) {
		...
		va.blendMode = t.blendMode;
		let a = r.bindGroup.getBindGroup(t.bindGroup, n, 1), o = r.pipeline.getPipeline(this._geometry, n, va, t.topology, this._shader._overrides);
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/mask/color/CanvasColorMaskPipe.mjs
var ba = class {
	constructor(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/mask/stencil/CanvasStencilMaskPipe.mjs
...
function Sa(e, t) {
	switch (t.type) {
		...
		case "roundedRectangle": {
			let n = t;
			xa(e, n.x, n.y, n.width, n.height, n.radius);
			break;
		}
		case "circle": {
			let n = t;
...
function Ca(e, t, n) {
	let r = [], i = [], a = [];
	if (!qn[t.type]?.build(t, r)) return !1;
	jn(r, n, !1, t.closePath ?? !0, i, a);
...
function wa(e, t) {
	...
	for (let n = 0; n < t.length; n++) {
		...
		a && (e.save(), e.transform(i.a, i.b, i.c, i.d, i.tx, i.ty)), Sa(e, r.shape), a && e.restore();
	}
	return !0;
}
var Ta = class {
	...
	execute(e) {
		...
		for (let e = 0; e < o.length; e++) {
			...
			for (let e = 0; e < u.length; e++) {
				...
				a && (r.save(), r.transform(n.a, n.b, n.c, n.d, n.tx, n.ty)), l && i.style ? s = Ca(r, t.shape, i.style) || s : (Sa(r, t.shape), c = wa(r, t.holes) || c, s = !0), a && r.restore();
			}
		}
		if (!s) {
	...
	_warnOnce(e, t) {
		this._warnedMaskTypes.has(e) || (this._warnedMaskTypes.add(e), f(t));
	}
};
Ta.extension = {
	type: [x.CanvasPipes],
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/canvas/utils/mapCanvasBlendModesToPixi.mjs
var X = "source-over";
function Ea() {
	let e = ce(), t = /* @__PURE__ */ Object.create(null);
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/canvas/CanvasContextSystem.mjs
var Da = new I(), Oa = class {
	constructor(e) {
		this.activeResolution = 1, this.smoothProperty = "imageSmoothingEnabled", this.blendModes = Ea(), this._activeBlendMode = "normal", this._projTransform = null, this._outerBlend = !1, this._warnedBlendModes = /* @__PURE__ */ new Set(), this._renderer = e;
	}
	resolutionChange(e) {
	...
	setContextTransform(e, t, n, r) {
		let i = r ? I.IDENTITY : this._renderer.globalUniforms.globalUniformData?.worldTransformMatrix || I.IDENTITY, a = Da;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/canvas/CanvasLimitsSystem.mjs
var ka = class {
	constructor() {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/canvas/CanvasGraphicsAdaptor.mjs
var Aa = "#808080", ja = new I(), Ma = new I(), Na = new I(), Pa = new I(), Fa = new I();
function Ia(e, t, n) {
	e.beginPath();
...
function za(e, t) {
	switch (t.type) {
		...
		case "roundedRectangle": {
			let n = t;
			Ra(e, n.x, n.y, n.width, n.height, n.radius);
			break;
		}
		case "circle": {
			let n = t;
...
function Ba(e, t) {
	...
	for (let n = 0; n < t.length; n++) {
		...
		if (!r?.shape) continue;
		let i = r.transform, a = i && !i.isIdentity();
		a && (e.save(), e.transform(i.a, i.b, i.c, i.d, i.tx, i.ty)), za(e, r.shape), a && e.restore();
	}
	return !0;
}
function Va(e, t, n, r) {
	...
	if (i instanceof G) {
		...
		let a = i.texture;
		if (a) {
			let o = z.getTintedPattern(a, t), s = n ? Pa.copyFrom(n).scale(a.source.pixelWidth, a.source.pixelHeight) : Pa.copyFrom(i.transform);
			return r && !e.textureSpace && s.append(r), z.applyPatternTransform(o, s), o;
		}
	}
	if (i instanceof Kr) {
		let e = z.getTintedPattern(i.texture, t);
		return z.applyPatternTransform(e, i.transform, !1), e;
	}
	let a = e.texture;
	if (a && a !== o.WHITE) {
		if (!a.source.resource) return Aa;
		let r = z.getTintedPattern(a, t), i = e.matrix;
		if (n) {
			let { resolution: e } = a.source;
			if (i = Pa.copyFrom(n), a.rotate) {
				let { uvs: t, orig: n } = a;
				i.prepend(Fa.set(t.x1 - t.x0, t.y1 - t.y0, t.x3 - t.x0, t.y3 - t.y0, t.x0, t.y0).invert()).scale(n.width * e, n.height * e);
			} else i.scale(a.source.pixelWidth, a.source.pixelHeight).translate(-a.frame.x * e, -a.frame.y * e);
		}
		return z.applyPatternTransform(r, i), r;
	}
	return La(t);
}
var Ha = class {
	...
	contextChange(e) {}
	execute(e, n) {
		let r = e.renderer, i = r.canvasContext, a = i.activeContext, s = n.groupTransform, c = r.globalUniforms.globalUniformData?.worldColor ?? 4294967295, l = n.groupColorAlpha, d = (c >>> 24 & 255) / 255, f = (l >>> 24 & 255) / 255, p = r.filter?.alphaMultiplier ?? 1, m = d * f * p;
		if (m <= 0) return;
		let h = c & 16777215, g = l & 16777215, _ = u(t(g, h)), v = r._roundPixels | n._roundPixels;
		a.save(), i.setContextTransform(s, v === 1), i.setBlendMode(n.groupBlendMode);
		let y = n.context.instructions;
		for (let e = 0; e < y.length; e++) {
			let n = y[e];
			if (n.action === "texture") {
				let e = n.data, r = e.image, o = r ? z.getCanvasSource(r) : null;
				if (!o) continue;
				let c = e.alpha * m;
				if (c <= 0) continue;
				let l = t(e.style, _);
				a.globalAlpha = c;
				let u = o;
				l !== 16777215 && (u = z.getTintedCanvas({ texture: r }, l));
				let d = r.frame, f = r.source._resolution ?? r.source.resolution ?? 1, p = d.x * f, h = d.y * f, g = d.width * f, y = d.height * f;
				u !== o && (p = 0, h = 0);
				let b = e.transform, x = b && !b.isIdentity(), S = r.rotate;
				x || S ? (ja.copyFrom(s), x && ja.append(b), S && T.matrixAppendRotationInv(ja, S, e.dx, e.dy, e.dw, e.dh), i.setContextTransform(ja, v === 1)) : i.setContextTransform(s, v === 1), a.drawImage(u, p, h, u === o ? g : u.width, u === o ? y : u.height, S ? 0 : e.dx, S ? 0 : e.dy, e.dw, e.dh), (x || S) && i.setContextTransform(s, v === 1);
				continue;
			}
			let r = n.data, c = r?.path?.shapePath;
			if (!c?.shapePrimitives?.length) continue;
			let l = r.style, u = t(l.color, _), d = l.alpha * m;
			if (d <= 0) continue;
			let f = n.action === "stroke";
			if (a.globalAlpha = d, f) {
				let e = l;
				a.lineWidth = e.width, a.lineCap = e.cap, a.lineJoin = e.join, a.miterLimit = e.miterLimit;
			}
			let p = c.shapePrimitives;
			...
			for (let e = 0; e < p.length; e++) {
				let t = p[e];
				if (!t?.shape) continue;
				let n = t.transform, r = n && !n.isIdentity(), i = l.texture && l.texture !== o.WHITE, c = l.textureSpace === "global" ? n : null, d = Va(l, u, i ? Kn(Ma, l, t.shape, c) : null, r ? Na.copyFrom(s).append(n) : s);
				if (r && (a.save(), a.transform(n.a, n.b, n.c, n.d, n.tx, n.ty)), f) {
					let e = l;
					if (e.alignment !== .5 && !e.pixelLine) {
						let n = [], r = [], i = [];
						qn[t.shape.type]?.build(t.shape, n) ? (jn(n, e, !1, t.shape.closePath ?? !0, r, i), a.fillStyle = d, Ia(a, r, i)) : (a.strokeStyle = d, a.beginPath(), za(a, t.shape), a.stroke());
					} else a.strokeStyle = d, a.beginPath(), za(a, t.shape), a.stroke();
				} else a.fillStyle = d, a.beginPath(), za(a, t.shape), Ba(a, t.holes) ? a.fill("evenodd") : a.fill();
				r && a.restore();
			}
		}
		a.restore();
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/canvas/renderTarget/CanvasRenderTargetAdaptor.mjs
var Ua = class {
	init(e, t) {
	...
	copyDepthTexture(e, t, n, r, i) {
		f("[CanvasRenderTargetAdaptor] copyDepthTexture is not supported in the canvas renderer");
	}
	destroyGpuRenderTarget(e) {}
	_ensureCanvas(e) {
		let t = e.resource;
		(!t || !oe.test(t)) && (t = S.get().createCanvas(e.pixelWidth, e.pixelHeight), e.resource = t), (t.width !== e.pixelWidth || t.height !== e.pixelHeight) && (t.width = e.pixelWidth, t.height = e.pixelHeight);
	...
	constructor(e) {
		super(e), this.adaptor = new Ua(), this.adaptor.init(e, this);
	}
};
Wa.extension = {
	type: [x.CanvasSystem],
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/canvas/texture/CanvasTextureSystem.mjs
var Ga = class {
	constructor(e) {}
	init() {}
	initSource(e) {}
	generateCanvas(e) {
		let t = S.get().createCanvas(), n = t.getContext("2d"), r = z.getCanvasSource(e);
		if (!r) return t;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/canvas/CanvasRenderer.mjs
var Ka = /* @__PURE__ */ re({ CanvasRenderer: () => $a }), qa = [
	...Oe,
	Oa,
	ka,
	Ga,
...
N.handleByNamedList(x.CanvasSystem, Xa), N.handleByNamedList(x.CanvasPipes, Za), N.handleByNamedList(x.CanvasPipesAdaptor, Qa), N.add(...qa, ...Ja, ...Ya);
var $a = class extends de {
	constructor() {
		let e = {
			name: "canvas",
			type: O.CANVAS,
			systems: Xa,
			renderPipes: Za,
			renderPipeAdaptors: Qa
		};
		super(e);
	}
}, eo = /* @__PURE__ */ ((e) => (e[e.ELEMENT_ARRAY_BUFFER = 34963] = "ELEMENT_ARRAY_BUFFER", e[e.ARRAY_BUFFER = 34962] = "ARRAY_BUFFER", e[e.UNIFORM_BUFFER = 35345] = "UNIFORM_BUFFER", e))(eo || {}), to = class {
	constructor(e, t) {
	...
	updateBuffer(e) {
		...
		let r = e.data, i = e.descriptor.usage & F.STATIC ? t.STATIC_DRAW : t.DYNAMIC_DRAW;
		return r ? n.byteLength >= r.byteLength ? t.bufferSubData(n.type, e._updateOffset, r, e._updateOffset / r.BYTES_PER_ELEMENT, (e._updateSize || r.byteLength) / r.BYTES_PER_ELEMENT) : (n.byteLength = r.byteLength, t.bufferData(n.type, r, i)) : (n.byteLength = e.descriptor.size, t.bufferData(n.type, n.byteLength, i)), n;
	}
	destroyAll(e = !1) {
	...
	createGLBuffer(e) {
		let { _gl: t } = this, n = eo.ARRAY_BUFFER;
		e.descriptor.usage & F.INDEX ? n = eo.ELEMENT_ARRAY_BUFFER : e.descriptor.usage & F.UNIFORM && (n = eo.UNIFORM_BUFFER);
		let r = new to(t.createBuffer(), n);
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/context/GlContextSystem.mjs
var ro = class e {
	constructor(e) {
		this.supports = {
			uint32Indices: !0,
	...
	init(t) {
		...
		if (t.context && n && (f("Renderer created with both a context and multiview enabled. Disabling multiView as both cannot work together."), n = !1), this.canvas = n ? S.get().createCanvas(this._renderer.canvas.width, this._renderer.canvas.height) : this._renderer.view.canvas, t.context) this.initFromContext(t.context);
		else {
	...
	ensureCanvasSize(e) {
		if (!this.multiView) {
			e !== this.canvas && f("multiView is disabled, but targetCanvas is not the main canvas");
			return;
		}
		let { canvas: t } = this;
	...
	validateContext(e) {
		...
		t && !t.stencil && f("Provided WebGL context does not have a stencil buffer, masks may not render correctly");
		let n = this.supports, r = this.webGLVersion === 2, i = this.extensions;
		n.uint32Indices = r || !!i.uint32ElementIndex, n.uniformBufferObject = r, n.vertexArrayObject = r || !!i.vertexArrayObject, n.srgbTextures = r || !!i.srgb, n.nonPowOf2wrapping = r, n.nonPowOf2mipmaps = r, n.msaa = r, n.uint32Indices || f("Provided WebGL context does not support 32 index buffer, large scenes may not render correctly");
	}
};
ro.extension = {
	type: [x.WebGLSystem],
...
var io = ro, ao = /* @__PURE__ */ ((e) => (e[e.RGBA = 6408] = "RGBA", e[e.RGB = 6407] = "RGB", e[e.RG = 33319] = "RG", e[e.RED = 6403] = "RED", e[e.RGBA_INTEGER = 36249] = "RGBA_INTEGER", e[e.RGB_INTEGER = 36248] = "RGB_INTEGER", e[e.RG_INTEGER = 33320] = "RG_INTEGER", e[e.RED_INTEGER = 36244] = "RED_INTEGER", e[e.ALPHA = 6406] = "ALPHA", e[e.LUMINANCE = 6409] = "LUMINANCE", e[e.LUMINANCE_ALPHA = 6410] = "LUMINANCE_ALPHA", e[e.DEPTH_COMPONENT = 6402] = "DEPTH_COMPONENT", e[e.DEPTH_STENCIL = 34041] = "DEPTH_STENCIL", e))(ao || {}), oo = /* @__PURE__ */ ((e) => (e[e.TEXTURE_2D = 3553] = "TEXTURE_2D", e[e.TEXTURE_CUBE_MAP = 34067] = "TEXTURE_CUBE_MAP", e[e.TEXTURE_2D_ARRAY = 35866] = "TEXTURE_2D_ARRAY", e[e.TEXTURE_CUBE_MAP_POSITIVE_X = 34069] = "TEXTURE_CUBE_MAP_POSITIVE_X", e[e.TEXTURE_CUBE_MAP_NEGATIVE_X = 34070] = "TEXTURE_CUBE_MAP_NEGATIVE_X", e[e.TEXTURE_CUBE_MAP_POSITIVE_Y = 34071] = "TEXTURE_CUBE_MAP_POSITIVE_Y", e[e.TEXTURE_CUBE_MAP_NEGATIVE_Y = 34072] = "TEXTURE_CUBE_MAP_NEGATIVE_Y", e[e.TEXTURE_CUBE_MAP_POSITIVE_Z = 34073] = "TEXTURE_CUBE_MAP_POSITIVE_Z", e[e.TEXTURE_CUBE_MAP_NEGATIVE_Z = 34074] = "TEXTURE_CUBE_MAP_NEGATIVE_Z", e))(oo || {}), Z = /* @__PURE__ */ ((e) => (e[e.UNSIGNED_BYTE = 5121] = "UNSIGNED_BYTE", e[e.UNSIGNED_SHORT = 5123] = "UNSIGNED_SHORT", e[e.UNSIGNED_SHORT_5_6_5 = 33635] = "UNSIGNED_SHORT_5_6_5", e[e.UNSIGNED_SHORT_4_4_4_4 = 32819] = "UNSIGNED_SHORT_4_4_4_4", e[e.UNSIGNED_SHORT_5_5_5_1 = 32820] = "UNSIGNED_SHORT_5_5_5_1", e[e.UNSIGNED_INT = 5125] = "UNSIGNED_INT", e[e.UNSIGNED_INT_10F_11F_11F_REV = 35899] = "UNSIGNED_INT_10F_11F_11F_REV", e[e.UNSIGNED_INT_2_10_10_10_REV = 33640] = "UNSIGNED_INT_2_10_10_10_REV", e[e.UNSIGNED_INT_24_8 = 34042] = "UNSIGNED_INT_24_8", e[e.UNSIGNED_INT_5_9_9_9_REV = 35902] = "UNSIGNED_INT_5_9_9_9_REV", e[e.BYTE = 5120] = "BYTE", e[e.SHORT = 5122] = "SHORT", e[e.INT = 5124] = "INT", e[e.FLOAT = 5126] = "FLOAT", e[e.FLOAT_32_UNSIGNED_INT_24_8_REV = 36269] = "FLOAT_32_UNSIGNED_INT_24_8_REV", e[e.HALF_FLOAT = 36193] = "HALF_FLOAT", e))(Z || {}), so = {
...
function co(e) {
	return so[e] ?? so.float32;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/geometry/GlGeometrySystem.mjs
var lo = {
	"point-list": 0,
	"line-list": 1,
	"line-strip": 3,
	...
	initGeometryVao(e, t, n = !0) {
		...
		o || (o = new uo(), e._gpuData[this._renderer.uid] = o, this._managedGeometries.add(e));
	...
	activateVao(e, t) {
		...
		for (let e in i) {
			...
			if (l) {
				...
				let t = P(o.format), i = co(o.format);
	...
	draw(e, t, n, r) {
		let { gl: i } = this._renderer, a = this._activeGeometry, o = lo[e || a.topology];
		...
		} else r === 1 ? i.drawArrays(o, n || 0, t || a.vertexCount) : i.drawArraysInstanced(o, n || 0, t || a.vertexCount, r);
		return this;
	}
	unbind() {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/GlBackBufferSystem.mjs
var po = new ie({ attributes: { aPosition: [
	-1,
	-1,
	3,
	-1,
	...
	init(t = {}) {
		...
		this.useBackBuffer = n, this._antialias = r, this._renderer.context.supports.msaa || (f("antialiasing, is not supported on when using the back buffer"), this._antialias = !1), this._state = M.for2d();
		let i = new k({
			vertex: "\n                attribute vec2 aPosition;\n                out vec2 vUv;\n\n                void main() {\n                    gl_Position = vec4(aPosition, 0.0, 1.0);\n\n                    vUv = (aPosition + 1.0) / 2.0;\n\n                    // flip dem UVs\n                    vUv.y = 1.0 - vUv.y;\n                }",
			fragment: "\n                in vec2 vUv;\n                out vec4 finalColor;\n\n                uniform sampler2D uTexture;\n\n                void main() {\n                    finalColor = texture(uTexture, vUv);\n                }",
			name: "big-triangle"
		});
		this._bigTriangleShader = new ne({
			glProgram: i,
			resources: { uTexture: o.WHITE.source }
		});
	}
	renderStart(e) {
	...
	_presentBackBuffer() {
		...
		e.renderTarget.finishRenderPass(), this._useBackBufferThisRender && (e.renderTarget.bind({
			target: this._targetTexture,
			clear: !1
		}), this._bigTriangleShader.resources.uTexture = this._backBufferTexture.source, e.encoder.draw({
			geometry: po,
	...
	_getBackBufferTexture(e) {
		return this._backBufferTexture = this._backBufferTexture || new o({ source: new a({
			width: e.width,
			height: e.height,
			resolution: e._resolution,
...
mo.extension = {
	...
	name: "backBuffer",
	priority: 1
}, mo.defaultOptions = { useBackBuffer: !1 };
var ho = mo, go = class {
	constructor(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/GlEncoderSystem.mjs
var _o = class {
	constructor(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/GlLimitsSystem.mjs
var vo = class {
	constructor(e) {
		this._renderer = e;
	}
	contextChange() {
		...
		this.maxTextures = e.getParameter(e.MAX_TEXTURE_IMAGE_UNITS), this.maxBatchableTextures = ue(this.maxTextures, e);
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/GlRenderTarget.mjs
var yo = class {
	constructor() {
	...
	resetState() {
		this._stencilCache.enabled = !1, this._stencilCache.stencilMode = Ne.NONE, this._stencilCache.stencilReference = 0;
	}
	setStencilMode(e, t) {
		let n = this._renderTargetStencilState[this._activeRenderTarget.uid], r = this._gl, i = Je[e], a = this._stencilCache;
		if (n.stencilMode = e, n.stencilReference = t, e === Ne.DISABLED) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/utils/createUboElementsSTD40.mjs
var xo = {
	f32: 4,
	i32: 4,
	"vec2<f32>": 8,
...
function So(e) {
	...
	for (let e = 0; e < t.length; e++) {
		let i = t[e];
		if (n = xo[i.data.type], !n) throw Error(`Unknown type ${i.data.type}`);
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/utils/generateArraySyncSTD40.mjs
function Co(e, t) {
	let n = Math.max(xo[e.data.type] / 16, 1), r = e.data.value.length / e.data.size, i = (4 - r % 4) % 4, a = e.data.type.indexOf("i32") >= 0 ? "dataInt32" : "data";
	return `
        v = uv.${e.data.name};
        offset += ${t};
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/utils/createUboSyncSTD40.mjs
function wo(e) {
	return He(e, We, Co);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/GlUboSystem.mjs
var To = class extends Ge {
	constructor() {
		super({
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/renderTarget/GlRenderTargetAdaptor.mjs
var Eo = class {
	constructor() {
		this._clearColorCache = [
			...
			0,
			0
		], this._viewPortCache = new e(), this._boundFramebuffer = void 0;
	}
	init(e, t) {
	...
	contextChange() {
		...
		for (let e = 1; e <= 16; e++) this._drawBuffersCache[e] = Array.from({ length: e }, (e, n) => t.COLOR_ATTACHMENT0 + n);
	}
	copyToTexture(e, t, n, r, i) {
		let a = this._renderTargetSystem, o = this._renderer, s = a.getGpuRenderTarget(e), c = o.gl;
		return this.finishRenderPass(e), c.bindFramebuffer(c.FRAMEBUFFER, s.resolveTargetFramebuffer), this._boundFramebuffer = s.resolveTargetFramebuffer, o.texture.bind(t, 0), c.copyTexSubImage2D(c.TEXTURE_2D, 0, i.x, i.y, n.x, n.y, r.width, r.height), t;
	}
	copyDepthTexture(e, t, n, r, i) {
		let a = this._renderTargetSystem, o = this._renderer.gl;
		this.finishRenderPass(e);
		let s = a.getRenderTarget(t), c = a.getGpuRenderTarget(e), l = a.getGpuRenderTarget(s);
		o.bindFramebuffer(o.READ_FRAMEBUFFER, c.framebuffer), o.bindFramebuffer(o.DRAW_FRAMEBUFFER, l.framebuffer), this._boundFramebuffer = void 0, o.blitFramebuffer(n.x, n.y, n.x + r.width, n.y + r.height, i.x, i.y, i.x + r.width, i.y + r.height, o.DEPTH_BUFFER_BIT, o.NEAREST);
	}
	startRenderPass(e, t = !0, n, r, i = 0, a = 0) {
		...
		if (i > 0) {
			if (o.msaa) throw Error("[RenderTargetSystem] Rendering to mip levels is not supported with MSAA render targets.");
			if (this._renderer.context.webGLVersion < 2) throw Error("[RenderTargetSystem] Rendering to mip levels requires WebGL2.");
		}
		e.colorAttachments.forEach((e) => {
			this._renderer.texture.unbind(e.texture);
		});
		let s = this._renderer.gl;
		this.bindFramebuffer(o.framebuffer), !e.isRoot && e.colorAttachments.length > 0 && (o._attachedMipLevel !== i || o._attachedLayer !== a) && (e.colorAttachments.forEach((e, t) => {
			let n = e.texture, r = this._renderer.texture.getGlSource(n);
			if (r.target === s.TEXTURE_2D) {
				if (a !== 0) throw Error("[RenderTargetSystem] layer must be 0 when rendering to 2D textures in WebGL.");
				s.framebufferTexture2D(s.FRAMEBUFFER, s.COLOR_ATTACHMENT0 + t, s.TEXTURE_2D, r.texture, i);
			} else if (r.target === s.TEXTURE_2D_ARRAY) {
				if (this._renderer.context.webGLVersion < 2) throw Error("[RenderTargetSystem] Rendering to 2D array textures requires WebGL2.");
				s.framebufferTextureLayer(s.FRAMEBUFFER, s.COLOR_ATTACHMENT0 + t, r.texture, i, a);
			} else if (r.target === s.TEXTURE_CUBE_MAP) {
				if (a < 0 || a > 5) throw Error("[RenderTargetSystem] Cube map layer must be between 0 and 5.");
				s.framebufferTexture2D(s.FRAMEBUFFER, s.COLOR_ATTACHMENT0 + t, s.TEXTURE_CUBE_MAP_POSITIVE_X + a, r.texture, i);
			} else throw Error("[RenderTargetSystem] Unsupported texture target for render-to-layer in WebGL.");
		}), o._attachedMipLevel = i, o._attachedLayer = a), o.framebuffer && (e.depthStencilAttachment ? this._attachDepthStencilTexture(e, i, a) : !o.depthStencilRenderBuffer && (e.stencil || e.depth) && this._initStencil(o)), e.colorAttachments.length > 1 && this._setDrawBuffers(e, s);
		let c = r.y;
		e.isRoot && (c = e.pixelHeight - r.height - r.y);
		let l = this._viewPortCache;
		(l.x !== r.x || l.y !== c || l.width !== r.width || l.height !== r.height) && (l.x = r.x, l.y = c, l.width = r.width, l.height = r.height, s.viewport(r.x, c, r.width, r.height)), this.clear(e, t, n);
	}
	finishRenderPass(e) {
		let t = this._renderTargetSystem.getGpuRenderTarget(e);
		if (!t.msaa || e.colorAttachments.length === 0) return;
		let n = this._renderer.gl;
		n.bindFramebuffer(n.FRAMEBUFFER, t.resolveTargetFramebuffer), n.bindFramebuffer(n.READ_FRAMEBUFFER, t.framebuffer), n.blitFramebuffer(0, 0, t.width, t.height, 0, 0, t.width, t.height, n.COLOR_BUFFER_BIT, n.NEAREST), n.bindFramebuffer(n.FRAMEBUFFER, t.framebuffer), this._boundFramebuffer = t.framebuffer;
	}
	initGpuRenderTarget(e) {
		let t = this._renderer.gl, n = new yo();
		n._attachedMipLevel = 0, n._attachedLayer = 0;
		let r = e.colorTexture;
		return r instanceof oe ? (this._renderer.context.ensureCanvasSize(r.resource), n.framebuffer = null, n) : (n.width = e.pixelWidth, n.height = e.pixelHeight, e.colorAttachments.length === 0 ? this._initDepth(e, n) : this._initColor(e, n), e.depthStencilAttachment && this._attachDepthStencilTexture(e, 0, 0), t.bindFramebuffer(t.FRAMEBUFFER, null), this._boundFramebuffer = null, n);
	}
	destroyGpuRenderTarget(e) {
		let t = this._renderer.gl;
	...
	clear(e, t, n, r, i = 0, a = 0) {
		...
		if (typeof t == "boolean" && (t = t ? B.ALL : B.NONE), e.colorAttachments.length === 0 && (t &= ~B.COLOR, !t)) return;
		let s = this._renderer.gl, c = !!(t & B.DEPTH) && !this._renderer.state.depthMaskEnabled;
		if (t & B.COLOR) {
		...
		c && s.depthMask(!0), s.clear(t), c && s.depthMask(!1);
	}
	resizeGpuRenderTarget(e) {
		if (e.isRoot) return;
		let t = this._renderTargetSystem.getGpuRenderTarget(e);
		t.width = e.pixelWidth, t.height = e.pixelHeight, e.colorAttachments.length > 0 && this._resizeColor(e, t), t.depthStencilRenderBuffer && this._resizeStencil(t), this._boundFramebuffer = void 0;
	}
	_initColor(e, t) {
		let n = this._renderer, r = n.gl, i = r.createFramebuffer();
		if (t.resolveTargetFramebuffer = i, r.bindFramebuffer(r.FRAMEBUFFER, i), e.colorAttachments.forEach((e, i) => {
			let a = e.texture;
			a.antialias && (n.context.supports.msaa ? t.msaa = !0 : f("[RenderTexture] Antialiasing on textures is not supported in WebGL1")), n.texture.bindSource(a, 0);
			...
			t.framebuffer = n, r.bindFramebuffer(r.FRAMEBUFFER, n), e.colorAttachments.forEach((e, n) => {
	...
	_initDepth(e, t) {
		...
		if (n.context.webGLVersion < 2) throw Error("[RenderTargetSystem] Depth-only render targets require WebGL2.");
		let r = n.gl, i = r.createFramebuffer();
		t.resolveTargetFramebuffer = i, t.framebuffer = i, r.bindFramebuffer(r.FRAMEBUFFER, i), r.drawBuffers([r.NONE]), r.readBuffer(r.NONE);
	}
	_resizeColor(e, t) {
		let n = e.colorAttachments[0].texture;
		if (t._attachedMipLevel = 0, t._attachedLayer = 0, e.colorAttachments.forEach((e, t) => {
			t !== 0 && e.texture.resize(n.width, n.height, n._resolution);
		}), t.msaa) {
			let n = this._renderer, r = n.gl, i = t.framebuffer;
			r.bindFramebuffer(r.FRAMEBUFFER, i), e.colorAttachments.forEach((e, i) => {
				let a = e.texture;
	...
	_attachDepthStencilTexture(e, t, n) {
		let r = this._renderer, i = r.gl, a = e.depthStencilAttachment.texture, o = r.texture.getGlSource(a), s = o.texture, c = a.format, l;
		l = c === "depth24plus-stencil8" || c === "depth32float-stencil8" ? i.DEPTH_STENCIL_ATTACHMENT : c === "stencil8" ? i.STENCIL_ATTACHMENT : i.DEPTH_ATTACHMENT, o.target === i.TEXTURE_2D ? i.framebufferTexture2D(i.FRAMEBUFFER, l, i.TEXTURE_2D, s, t) : o.target === i.TEXTURE_2D_ARRAY ? i.framebufferTextureLayer(i.FRAMEBUFFER, l, s, t, n) : o.target === i.TEXTURE_CUBE_MAP && i.framebufferTexture2D(i.FRAMEBUFFER, l, i.TEXTURE_CUBE_MAP_POSITIVE_X + n, s, t);
	}
	_initStencil(e) {
	...
	prerender(e) {
		if (e.colorAttachments.length === 0) return;
		let t = e.colorAttachments[0].texture.resource;
		this._renderer.context.multiView && oe.test(t) && this._renderer.context.ensureCanvasSize(t);
	}
	postrender(e) {
		if (!this._renderer.context.multiView || e.colorAttachments.length === 0) return;
		let t = e.colorAttachments[0].texture;
		if (oe.test(t.resource)) {
			let e = this._renderer.context.canvas, n = t;
			n.context2D.drawImage(e, 0, n.pixelHeight - e.height);
		}
	}
	_setDrawBuffers(e, t) {
		let n = e.colorAttachments.length, r = this._drawBuffersCache[n];
		if (this._renderer.context.webGLVersion === 1) {
			let e = this._renderer.context.extensions.drawBuffers;
			e ? e.drawBuffersWEBGL(r) : f("[RenderTexture] This WebGL1 context does not support rendering to multiple targets");
		} else t.drawBuffers(r);
	}
	resetState() {
		this._boundFramebuffer = void 0, this._viewPortCache = new e(), this._clearColorCache = [
			0,
			0,
			0,
			0
	...
	bindFramebuffer(e) {
		this._boundFramebuffer !== e && (this._boundFramebuffer = e, this._renderer.gl.bindFramebuffer(this._renderer.gl.FRAMEBUFFER, e));
	}
}, Do = class extends Ae {
	constructor(e) {
		super(e), this.adaptor = new Eo(), this.adaptor.init(e, this);
	}
	resetState() {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/shared/texture/TextureView.mjs
var Oo = class extends te {
	constructor(e, t) {
		super(), this._resourceType = "textureView", this._resourceId = d("resource"), this._touched = 0, this.source = e, this.viewDescriptor = t, this._onChange = this._onChange.bind(this), this._onDestroy = this._onDestroy.bind(this), this.source.on("change", this._onChange), this.source.on("destroy", this._onDestroy);
	}
	_onChange() {
	...
	destroy() {
		this.source && (this.source.off("change", this._onChange), this.source.off("destroy", this._onDestroy)), this.emit("destroy", this), this.removeAllListeners();
	}
};
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/GenerateShaderSyncCode.mjs
function ko(e, t) {
	let n = [], r = ["\n        var g = s.groups;\n        var sS = r.shader;\n        var p = s.glProgram;\n        var ugS = r.uniformGroup;\n        var resources;\n    "], i = !1, o = 0, s = t._getProgramData(e.glProgram);
	for (let c in e.groups) {
		...
		for (let u in l.resources) {
			...
			if (d instanceof w) {
                ...
                `);
			} else if (d instanceof a || d instanceof Oo) {
				let a = e._uniformBindMap[c][u], l = s.uniformData[a];
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/GlProgramData.mjs
var Ao = class {
	constructor(e, t) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/compileShader.mjs
function jo(e, t, n) {
	let r = e.createShader(t);
	return e.shaderSource(r, n), e.compileShader(r), r;
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/defaultValue.mjs
function Mo(e) {
	let t = Array(e);
...
function No(e, t) {
	switch (e) {
		...
		case "bool": return !1;
		case "bvec2": return Mo(2 * t);
		case "bvec3": return Mo(3 * t);
		case "bvec4": return Mo(4 * t);
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/mapType.mjs
var Po = null, Fo = {
	FLOAT: "float",
	FLOAT_VEC2: "vec2",
	FLOAT_VEC3: "vec3",
...
function Ro(e, t) {
	return Io[Lo(e, t)] || "float32";
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/extractAttributesFromGlProgram.mjs
function zo(e, t, n = !1) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/getUboData.mjs
function Bo(e, t) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/getUniformData.mjs
function Vo(e, t) {
	let n = {}, r = t.getProgramParameter(e, t.ACTIVE_UNIFORMS);
	for (let i = 0; i < r; i++) {
		let r = t.getActiveUniform(e, i), a = r.name.replace(/\[.*?\]$/, ""), o = !!r.name.match(/\[.*?\]$/), s = Lo(t, r.type);
		n[a] = {
			name: a,
			index: i,
			type: s,
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/logProgramError.mjs
function Ho(e, t) {
...
function Uo(e, t, n, r) {
	e.getProgramParameter(t, e.LINK_STATUS) || (e.getShaderParameter(n, e.COMPILE_STATUS) || Ho(e, n), e.getShaderParameter(r, e.COMPILE_STATUS) || Ho(e, r), console.error("PixiJS Error: Could not initialize shader."), e.getProgramInfoLog(t) !== "" && console.warn("PixiJS Warning: gl.getProgramInfoLog()", e.getProgramInfoLog(t)));
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/program/generateProgram.mjs
function Wo(e, t) {
	let n = jo(e, e.VERTEX_SHADER, t.vertex), r = jo(e, e.FRAGMENT_SHADER, t.fragment), i = e.createProgram();
	e.attachShader(i, n), e.attachShader(i, r);
	let a = t.transformFeedbackVaryings;
	a && (typeof e.transformFeedbackVaryings == "function" ? e.transformFeedbackVaryings(i, a.names, a.bufferMode === "separate" ? e.SEPARATE_ATTRIBS : e.INTERLEAVED_ATTRIBS) : f("TransformFeedback is not supported but TransformFeedbackVaryings are given.")), e.linkProgram(i), e.getProgramParameter(i, e.LINK_STATUS) || Uo(e, i, n, r), t._attributeData = zo(i, e, !/^[ \t]*#[ \t]*version[ \t]+300[ \t]+es[ \t]*$/m.test(t.vertex)), t._uniformData = Vo(i, e), t._uniformBlockData = Bo(i, e), e.deleteShader(n), e.deleteShader(r);
	let o = {};
	for (let n in t._uniformData) {
		let r = t._uniformData[n];
		o[n] = {
			location: e.getUniformLocation(i, n),
			value: No(r.type, r.size)
		};
	}
	return new Ao(i, o);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/GlShaderSystem.mjs
var Go = {
	textureCount: 0,
	blockIndex: 0
}, Ko = class {
	...
	bind(e, t) {
		...
		Go.textureCount = 0, Go.blockIndex = 0;
		let n = this._shaderSyncFunctions[e.glProgram._key];
		n ||= this._shaderSyncFunctions[e.glProgram._key] = this._generateShaderSync(e, this), this._renderer.buffer.nextBindBase(!!e.glProgram.transformFeedbackVaryings), n(this._renderer, e, Go);
	}
	updateUniformGroup(e) {
		this._renderer.uniformGroup.updateUniformGroup(e, this._activeProgram, Go);
	}
	...
	_createProgramData(e) {
		let t = e._key;
		return this._programDataHash[t] = Wo(this._gl, e), this._programDataHash[t];
	}
	destroy() {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/utils/generateUniformsSyncTypes.mjs
var qo = {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/utils/generateUniformsSync.mjs
function Yo(e, t) {
	let n = ["\n        var v = null;\n        var cv = null;\n        var cu = null;\n        var t = 0;\n        var gl = renderer.gl;\n        var name = null;\n    "];
	for (let r in e.uniforms) {
		if (!t[r]) {
			e.uniforms[r] instanceof w ? e.uniforms[r].ubo ? n.push(`
                        renderer.shader.bindUniformBlock(uv.${r}, "${r}");
                    `) : n.push(`
                        renderer.shader.updateUniformGroup(uv.${r});
                    `) : e.uniforms[r] instanceof Ye && n.push(`
		...
		for (let e = 0; e < Re.length; e++) {
			...
			if (i.type === t.type && t.test(i)) {
				n.push(`name = "${r}";`, Re[e].uniform), a = !0;
				break;
			}
		}
		if (!a) {
			let e = (i.size === 1 ? qo : Jo)[i.type].replace("location", `ud["${r}"].location`);
			n.push(`
            cu = ud["${r}"];
            cv = cu.value;
            v = uv["${r}"];
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/shader/GlUniformGroupSystem.mjs
var Xo = class {
	constructor(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/state/mapWebGLBlendModesToPixi.mjs
function Zo(e) {
	let t = {};
	if (t.normal = [e.ONE, e.ONE_MINUS_SRC_ALPHA], t.add = [e.ONE, e.ONE], t.multiply = [
		...
		e.ONE,
		e.ONE_MINUS_SRC_ALPHA
	], t.erase = [e.ZERO, e.ONE_MINUS_SRC_ALPHA], !(e instanceof S.get().getWebGLRenderingContext())) t.min = [
		e.ONE,
		e.ONE,
		e.ONE,
		e.ONE,
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/state/GlStateSystem.mjs
var { BLEND: Qo, OFFSET: $o, CULLING: es, DEPTH_TEST: ts, WINDING: ns, DEPTH_MASK: rs } = b, is = class e {
	constructor(e) {
		this._invertFrontFace = !1, this.gl = null, this.stateId = 0, this.polygonOffset = 0, this.blendMode = "none", this._blendEq = !1, this.map = [], this.map[Qo] = this.setBlend, this.map[$o] = this.setOffset, this.map[es] = this.setCullFace, this.map[ts] = this.setDepthTest, this.map[ns] = this.setFrontFace, this.map[rs] = this.setDepthMask, this.checks = [], this.defaultState = M.for2d(), e.renderTarget.onRenderTargetChange.add(this);
	}
	onRenderTargetChange(e) {
		this._invertFrontFace = !e.isRoot != !!e.flipY, this._cullFace ? this.setFrontFace(this._frontFace) : this._frontFaceDirty = !0;
	}
	contextChange(e) {
		this.gl = e, this.blendModesMap = Zo(e), this.resetState();
	}
	set(e) {
...
var as = is, os = class {
	constructor(e) {
		this.target = oo.TEXTURE_2D, this._layerInitMask = 0, this.texture = e, this.width = -1, this.height = -1, this.type = Z.UNSIGNED_BYTE, this.internalFormat = ao.RGBA, this.format = ao.RGBA, this.samplerType = 0;
	}
	destroy() {}
}, ss = {
	id: "buffer",
	...
	upload(e, t, n, r, i, a) {
		...
		let s = e.pixelWidth, c = e.pixelHeight, l = !!cs[e.format];
	...
	return {
		...
		upload(t, n, r, i) {
			...
			for (let t = 0; t < us.length; t++) {
				let o = a[us[t]];
				o.resource && ((e[o.uploadMethodId] || e.image).upload(o, n, r, i, oo.TEXTURE_CUBE_MAP_POSITIVE_X + t, !(n._layerInitMask & 1 << t)), n._layerInitMask |= 1 << t);
			}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/texture/uploaders/glUploadImageResource.mjs
var fs = {
	id: "image",
	upload(e, t, n, r, i, a = !1) {
		...
		(d ? ps : ms)(n, o, t, s, c, l, u, m, f, p), t.width = s, t.height = c;
	}
};
...
function ms(e, t, n, r, i, a, o, s, c, l) {
	if (!l) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/texture/uploaders/glUploadVideoResource.mjs
var hs = ma(), gs = {
	id: "video",
	upload(e, t, n, r, i, a = hs) {
		if (!e.isValid) {
			let e = i ?? t.target;
			n.texImage2D(e, 0, t.internalFormat, 1, 1, 0, t.format, t.type, null);
			return;
		}
		fs.upload(e, t, n, r, i, a);
	}
}, _s = {
	linear: 9729,
	nearest: 9728
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/texture/utils/applyStyleParams.mjs
function xs(e, t, n, r, i, a, o, s) {
	let c = a;
	if (!s || e.addressModeU !== "repeat" || e.addressModeV !== "repeat" || e.addressModeW !== "repeat") {
		let n = ys[o ? "clamp-to-edge" : e.addressModeU], r = ys[o ? "clamp-to-edge" : e.addressModeV], a = ys[o ? "clamp-to-edge" : e.addressModeW];
		t[i](c, t.TEXTURE_WRAP_S, n), t[i](c, t.TEXTURE_WRAP_T, r), t.TEXTURE_WRAP_R && t[i](c, t.TEXTURE_WRAP_R, a);
	}
	if ((!s || e.magFilter !== "linear") && t[i](c, t.TEXTURE_MAG_FILTER, _s[e.magFilter]), n) {
		if (!s || e.mipmapFilter !== "linear") {
			let n = vs[e.minFilter][e.mipmapFilter];
			t[i](c, t.TEXTURE_MIN_FILTER, n);
		}
	} else t[i](c, t.TEXTURE_MIN_FILTER, _s[e.minFilter]);
	...
	e.compare ? (t[i](c, t.TEXTURE_COMPARE_FUNC, bs[e.compare]), t[i](c, t.TEXTURE_COMPARE_MODE, t.COMPARE_REF_TO_TEXTURE)) : s || t[i](c, t.TEXTURE_COMPARE_MODE, t.NONE);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/texture/utils/mapFormatToGlFormat.mjs
function Ss(e) {
	return {
		r8unorm: e.RED,
		r8snorm: e.RED,
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/texture/utils/mapFormatToGlInternalFormat.mjs
function Cs(e, t) {
	let n = {}, r = e.RGBA;
	return e instanceof S.get().getWebGLRenderingContext() ? t.srgb && (n = {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/texture/utils/mapFormatToGlType.mjs
function ws(e) {
	return {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/texture/utils/mapViewDimensionToGlTarget.mjs
function Ts(e) {
	return {
		"2d": e.TEXTURE_2D,
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/texture/GlTextureSystem.mjs
var Es = 4, Ds = class e {
	constructor(t) {
	...
	contextChange(e) {
		this._gl = e, this._mapFormatToInternalFormat || (this._mapFormatToInternalFormat = Cs(e, this._renderer.context.extensions), this._mapFormatToType = ws(e), this._mapFormatToFormat = Ss(e), this._mapViewDimensionToGlTarget = Ts(e)), this._managedTextures.removeAll(!0), this._glSamplers = /* @__PURE__ */ Object.create(null), this._boundSamplers = /* @__PURE__ */ Object.create(null), this._premultiplyAlpha = !1;
	...
	bindSource(e, t = 0) {
		...
		if (e._gcLastUsed = this._renderer.gc.now, this._boundTextures[t] !== e) {
			this._boundTextures[t] = e, this._activateLocation(t), e ||= o.EMPTY.source;
	...
	_initSource(e) {
		let t = this._gl, n = new os(t.createTexture());
		...
		if (e.autoGenerateMipmaps && (this._renderer.context.supports.nonPowOf2mipmaps || e.isPowerOfTwo)) {
	...
	updateStyle(e, t) {
		...
		n.bindTexture(r.target, r.texture), this._boundTextures[this._activeTextureLocation] = e, xs(e.style, n, e.mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "texParameteri", r.target, !this._renderer.context.supports.nonPowOf2wrapping && !e.isPowerOfTwo, t);
	}
	...
	_initSampler(e) {
		...
		return this._glSamplers[e._resourceId] = n, xs(e, t, this._boundTextures[this._activeTextureLocation].mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "samplerParameteri", n, !1, !0), this._glSamplers[e._resourceId];
	}
	_getGlSampler(e) {
	...
	generateCanvas(e) {
		let { pixels: t, width: n, height: r } = this.getPixels(e), i = S.get().createCanvas();
	...
	getPixels(e) {
		let t = e.source.resolution, n = e.frame, r = Math.max(Math.round(n.width * t), 1), i = Math.max(Math.round(n.height * t), 1), a = new Uint8Array(Es * r * i), o = this._renderer, s = o.renderTarget.getRenderTarget(e), c = o.renderTarget.getGpuRenderTarget(s), l = o.gl;
		return o.renderTarget.adaptor.bindFramebuffer(c.resolveTargetFramebuffer), l.readPixels(Math.round(n.x * t), Math.round(n.y * t), r, i, l.RGBA, l.UNSIGNED_BYTE, a), {
	...
	resetState() {
		this._activeTextureLocation = -1, this._boundTextures.fill(o.EMPTY.source), this._boundSamplers = /* @__PURE__ */ Object.create(null);
		let e = this._gl;
...
Ds.extension = {
	type: [x.WebGLSystem],
	name: "texture"
}, Ds.uploadExtensions = /* @__PURE__ */ Object.create(null);
var Os = Ds;
N.handleByMap(x.TextureUploaderWebGL, Os.uploadExtensions);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/gl/GlGraphicsAdaptor.mjs
var ks = class {
	contextChange(e) {
		let t = new w({
			uColor: {
		...
		}), n = e.limits.maxBatchableTextures, r = Pe({
			name: "graphics",
			bits: [
				_e,
				Me(n),
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/mesh/gl/GlMeshAdaptor.mjs
var As = class {
	init() {
		let e = Pe({
			name: "mesh",
	...
	execute(e, t) {
		...
		if (!r) {
			...
			f("Mesh shader has no glProgram", t.shader);
			return;
		}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gl/WebGLRenderer.mjs
var js = /* @__PURE__ */ re({ WebGLRenderer: () => Rs }), Ms = [
	...Oe,
	To,
	ho,
	io,
...
N.handleByNamedList(x.WebGLSystem, Fs), N.handleByNamedList(x.WebGLPipes, Is), N.handleByNamedList(x.WebGLPipesAdaptor, Ls), N.add(...Ms, ...Ns, ...Ps);
var Rs = class extends de {
	constructor() {
		let e = {
			name: "webgl",
			type: O.WEBGL,
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/buffer/GpuBufferSystem.mjs
var Bs = class {
	constructor(e) {
		this.gpuBuffer = e;
	}
	...
	createGPUBuffer(e) {
		...
		return e._updateID = 0, e.data && (me(e.data.buffer, t.getMappedRange(), e.data.byteOffset, e.data.byteLength), t.unmap()), e._gpuData[this._renderer.uid] = new Bs(t), this._managedBuffers.add(e) && (e.on("update", this.updateBuffer, this), e.on("change", this.onBufferChange, this)), t;
	}
	onBufferChange(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/buffer/UboBatch.mjs
var Hs = class {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/GpuDeviceSystem.mjs
var Ws = class {
	constructor(e) {
		this._renderer = e;
	}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/GpuEncoderSystem.mjs
var Gs = class {
	constructor(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/GpuLimitsSystem.mjs
var Ks = class {
	constructor(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/GpuStencilSystem.mjs
var qs = class {
	constructor(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/createUboElementsWGSL.mjs
var Js = {
	i32: {
		align: 4,
		size: 4
...
function Ys(e) {
	...
	for (let e = 0; e < t.length; e++) {
		let r = t[e], i = Js[r.data.type].size, a = Js[r.data.type].align;
		if (!Js[r.data.type]) throw Error(`[Pixi.js] WebGPU UniformBuffer: Unknown type ${r.data.type}`);
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/generateArraySyncWGSL.mjs
function Xs(e, t) {
	let { size: n, align: r } = Js[e.data.type], i = (r - n) / 4, a = e.data.type.indexOf("i32") >= 0 ? "dataInt32" : "data";
	return `
         v = uv.${e.data.name};
         ${t === 0 ? "" : `offset += ${t};`}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/utils/createUboSyncFunctionWGSL.mjs
function Zs(e) {
	return He(e, qe, Xs);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/GpuUboSystem.mjs
var Qs = class extends Ge {
	constructor() {
		super({
			createUboElements: Ys,
			generateUboSync: Zs
		});
	}
};
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/GpuUniformBatchPipe.mjs
var $s = 128, ec = class {
	constructor(e) {
		this._bindGroupHash = /* @__PURE__ */ Object.create(null), this._buffers = [], this._bindGroups = [], this._bufferResources = [], this._renderer = e, this._batchBuffer = new Hs({ minUniformOffsetAlignment: $s });
		let t = 256 / $s;
		for (let e = 0; e < t; e++) {
			let t = F.UNIFORM | F.COPY_DST;
			e === 0 && (t |= F.COPY_SRC), this._buffers.push(new A({
	...
	getUniformBindGroup(e, t) {
		...
		return this._renderer.ubo.syncUniformGroup(e, this._batchBuffer.data, r / 4), this._bindGroupHash[e.uid] = this._getBindGroup(r / $s), this._bindGroupHash[e.uid];
	}
	getUboResource(e) {
		this._renderer.ubo.updateUniformGroup(e);
		let t = e.buffer.data, n = this._batchBuffer.addGroup(t);
		return this._getBufferResource(n / $s);
	}
	getArrayBindGroup(e) {
		let t = this._batchBuffer.addGroup(e);
		return this._getBindGroup(t / $s);
	}
	getArrayBufferResource(e) {
		let t = this._batchBuffer.addGroup(e) / $s;
	...
	_getBindGroup(e) {
		if (!this._bindGroups[e]) {
			let t = new ae({ 0: this._getBufferResource(e) });
	...
	_uploadBindGroups() {
		...
		for (let r = 1; r < this._buffers.length; r++) {
			...
			n.copyBufferToBuffer(e.getGPUBuffer(t), $s, e.getGPUBuffer(i), 0, this._batchBuffer.byteIndex);
		}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/pipeline/PipelineSystem.mjs
var tc = {
	"point-list": 0,
	"line-list": 1,
	"line-strip": 2,
...
var sc = /* @__PURE__ */ Object.create(null), cc = 0;
function lc(e) {
	let t = sc[e];
	return t === void 0 && (t = sc[e] = cc++), t;
}
...
var dc = class {
	...
	setRenderTarget(e) {
		let t = e.colorAttachments[0]?.texture;
		this._multisampleCount = t?.source.antialias ? 4 : 1, this._colorTargetCount = e.colorAttachments.length, this._colorFormat = t?.format ?? "bgra8unorm", this._colorFormatId = lc(this._colorFormat), this._depthStencilFormat = e.depthStencilAttachment?.texture.format, this._depthStencilFormatData = rc[this._depthStencilFormat] || ic, this._depthReadOnly = e.depthStencilAttachment?.depthReadOnly ?? !1, this._invertFrontFace = !!e.flipY, this._updatePipeHash();
	}
	setColorMask(e) {
		this._colorMask !== e && (this._colorMask = e, this._updatePipeHash());
	}
	setStencilMode(e) {
		this._stencilMode !== e && (this._stencilMode = e, this._stencilState = Je[e], this._updatePipeHash());
	}
	getBundleDescriptor() {
		let e = [];
	...
	getPipelineKey(e, t, n, r, i) {
		return e._layoutKey || (ze(e, t.attributeData), this._generateBufferKey(e)), oc(e._layoutKey, t._layoutKey, n.data, n._blendModeId, tc[r], i.id);
	}
	getPipeline(e, t, n, r, i) {
		e._layoutKey || (ze(e, t.attributeData), this._generateBufferKey(e)), r ||= e.topology, i ||= nc;
		let a = oc(e._layoutKey, t._layoutKey, n.data, n._blendModeId, tc[r], i.id), o = this._pipeCache.get(a);
		return o || (o = this._createPipeline(e, t, n, r, i), this._pipeCache.set(a, o)), o;
	}
	_createPipeline(e, t, n, r, i) {
		let a = this._gpu.device, o = this._createVertexBufferLayouts(e, t), s = this._renderer.state.getColorTargets(n, this._colorTargetCount, this._colorFormat), c = this._stencilMode === Ne.RENDERING_MASK_ADD ? 0 : this._colorMask;
		...
		u && (this._renderer.limits.supportsOverrideConstants ? p = i.data : (d = ac(d, i.data), f = ac(f, i.data)));
		let m = {
			vertex: {
	...
	_createVertexBufferLayouts(e, t) {
		...
		return e.buffers.forEach((n) => {
			...
			for (let r in t.attributeData) {
				...
				(o.divisor ?? 1) !== 1 && f(`Attribute ${r} has an invalid divisor value of '${o.divisor}'. WebGPU only supports a divisor value of 1`), o.buffer === n && (i.arrayStride = o.stride, i.stepMode = o.instance ? "instance" : "vertex", a.push({
	...
	_updatePipeHash() {
		var e;
		let t = uc(this._stencilMode, this._multisampleCount === 1 ? 0 : 1, this._colorMask, this._colorTargetCount, this._depthStencilFormatData.index, this._colorFormatId, +!!this._depthReadOnly, +!!this._invertFrontFace);
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/renderTarget/GpuRenderTarget.mjs
var fc = class {
	constructor() {
...
function mc(e) {
	...
	return f(`[WebGPU] CanvasSource format '${e}' is not a valid GPUCanvasContext format. Falling back to '${t}'. Allowed formats are: bgra8unorm, rgba8unorm, rgba16float.`), t;
}
var hc = class {
	constructor() {
	...
	startRenderPass(e, t = !0, n, r, i = 0, a = 0) {
		...
		let s = t;
		typeof s == "boolean" && (s = s ? B.ALL : B.NONE), (e.stencil || e.depth) && !e.depthStencilAttachment && e.ensureDepthStencilTexture();
		let c = !!e.depthStencilAttachment, l = this._activePass;
		if (l !== null && l.renderTarget === e && l.mipLevel === i && l.layer === a && l.depthStencil === c && this._renderer.encoder.renderPassEncoder !== null && s === B.NONE) {
	...
	_getGpuColorTexture(e) {
		...
		let t = e.colorAttachments[0].texture;
		return t instanceof oe && t._gpuContext ? t._gpuContext.getCurrentTexture() : this._renderer.texture.getGpuSource(t);
	}
	getDescriptor(e, t, n, r = 0, i = 0) {
		...
		let a = this._renderTargetSystem, o = a.getGpuRenderTarget(e), s = e.colorAttachments.map((e, s) => {
			let c = e.texture, l = c instanceof oe ? c._gpuContext : null, u, d;
			if (l) {
				if (i !== 0) throw Error("[RenderTargetSystem] Rendering to array layers is not supported for canvas targets.");
				u = l.getCurrentTexture().createView(e.viewDescriptor);
			} else u = this._renderer.texture.getTextureRenderTargetView(e.texture, r, i, e.viewDescriptor);
			let f = !1;
			o.msaaTextures[s] && (d = u, u = this._renderer.texture.getTextureView(o.msaaTextures[s]), f = o.msaaTextures[s].transient);
			let p = e.loadOp;
			t !== void 0 && (p = t & B.COLOR ? "clear" : "load"), n ??= a.defaultClearColor;
			let m = e.storeOp ?? "store", h = {
				view: u,
				resolveTarget: d,
				storeOp: f ? "discard" : m,
				loadOp: p
			};
			p === "clear" && (n ??= e.clearValue ?? a.defaultClearColor, h.clearValue = n);
		...
		if (e.depthStencilAttachment) {
			...
			let n = e.depthStencilAttachment, a = n.texture.format.includes("stencil"), s = n.texture.format.includes("depth"), l = n.texture.transient ? "discard" : "store";
			c = { view: this._renderer.texture.getTextureRenderTargetView(n.texture, r, i, n.viewDescriptor) };
			let u = n.depthReadOnly ?? !1, d = n.stencilReadOnly ?? u;
			a && !d ? (c.stencilLoadOp = t & B.STENCIL ? "clear" : n.stencilLoadOp ?? "load", c.stencilStoreOp = n.stencilStoreOp ?? l, c.stencilLoadOp === "clear" && (c.stencilClearValue = n.stencilClearValue ?? 0)) : a && d && (c.stencilReadOnly = !0), s && !u ? (c.depthLoadOp = t & B.DEPTH ? "clear" : n.depthLoadOp ?? "load", c.depthStoreOp = n.depthStoreOp ?? l, c.depthLoadOp === "clear" && (c.depthClearValue = n.depthClearValue ?? 1)) : s && u && (c.depthReadOnly = !0);
			for (let e in n) e !== "texture" && e !== "viewDescriptor" && e !== "stencilLoadOp" && e !== "stencilStoreOp" && e !== "stencilClearValue" && e !== "stencilReadOnly" && e !== "depthLoadOp" && e !== "depthStoreOp" && e !== "depthClearValue" && e !== "depthReadOnly" && (c[e] = n[e]);
		}
		return {
			colorAttachments: s,
	...
	initGpuRenderTarget(e) {
		...
		return e.colorAttachments.forEach((e, n) => {
			...
			if (r instanceof oe) {
				if (!r._gpuContext) {
					let e = r.resource.getContext("webgpu"), t = r.transparent ? "premultiplied" : "opaque", n = mc(r.format);
					try {
						e.configure({
	...
	constructor(e) {
		super(e), this.adaptor = new hc(), this.adaptor.init(e, this);
	}
};
gc.extension = {
	type: [x.WebGPUSystem],
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/shader/GpuShaderSystem.mjs
var _c = class {
	constructor() {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/state/GpuBlendModesToPixi.mjs
var Q = {};
Q.normal = {
	alpha: {
		srcFactor: "one",
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/state/GpuStateSystem.mjs
var vc = class {
	constructor() {
		this.defaultState = new M(), this.defaultState.blend = !0;
	}
	contextChange(e) {
		this.gpu = e;
	}
	getColorTargets(e, t, n) {
		let r = e.blend ? Q[e.blendMode] || Q.normal : void 0, i = [];
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/texture/uploaders/gpuUploadBufferImageResource.mjs
var yc = {
	type: "image",
	upload(e, t, n, r = 0) {
	...
	type: "compressed",
	upload(e, t, n, r = 0) {
		let i = e.pixelWidth, a = e.pixelHeight, o = bc[e.format] || xc;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/texture/uploaders/gpuUploadImageSource.mjs
var Tc = {
	type: "image",
	upload(e, t, n, r = 0) {
		let i = e.resource;
		...
		if (globalThis.HTMLImageElement && i instanceof HTMLImageElement) {
			...
			t.getContext("2d").drawImage(i, 0, 0, i.width, i.height), e.resource = t, f("ImageSource: Image element passed, converting to canvas and replacing resource.");
		}
...
var Ac = class e {
	...
	_initSource(e) {
		...
		return e._gpuData[this._renderer.uid] = new Oc(o), this._managedTextures.add(e) && (e.on("update", this.onSourceUpdate, this), e.on("resize", this.onSourceResize, this), e.on("updateMipmaps", this.onUpdateMipmaps, this)), this.onSourceUpdate(e), o;
	}
	onSourceUpdate(e) {
	...
	onUpdateMipmaps(e) {
		this._mipmapGenerator ||= new Dc(this._gpu.device);
		let t = this.getGpuSource(e);
	...
	_createTextureBindGroup(e) {
		let t = e.source;
		return this._bindGroupHash[e.uid] = new ae({
			0: t,
			1: t.style,
			2: new w({ uTextureMatrix: {
				type: "mat3x3<f32>",
	...
	getTextureRenderTargetView(e, t = 0, n = 0, r) {
		...
		return r && (s = `${s}.${kc(r)}`), (i = o.textureViews)[s] || (i[s] = o.gpuTexture.createView({
			dimension: "2d",
			baseMipLevel: t,
			mipLevelCount: 1,
			baseArrayLayer: n,
	...
	getPixels(e) {
		let t = this.generateCanvas(e), n = Le.getOptimalCanvasAndContext(t.width, t.height), r = n.context;
		r.drawImage(t, 0, 0);
		let { width: i, height: a } = t, o = r.getImageData(0, 0, i, a), s = new Uint8ClampedArray(o.data.buffer);
		return Le.returnCanvasAndContext(n), {
			pixels: s,
			width: i,
			height: a
		};
...
Ac.extension = {
	type: [x.WebGPUSystem],
	name: "texture"
}, Ac.uploadExtensions = /* @__PURE__ */ Object.create(null);
var jc = Ac;
N.handleByMap(x.TextureUploaderWebGPU, jc.uploadExtensions);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/graphics/gpu/GpuGraphicsAdaptor.mjs
var Mc = class {
	constructor() {
		this._maxTextures = 0;
	}
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/mesh/gpu/GpuMeshAdapter.mjs
var Nc = class {
	init() {
		let e = pe({
			name: "mesh",
	...
	execute(e, t) {
		...
		if (!r) r = this._shader, r.groups[2] = n.texture.getTextureBindGroup(t.texture);
			...
			f("Mesh shader has no gpuProgram", t.shader);
			return;
		}
		let i = r.gpuProgram;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/gpu/WebGPURenderer.mjs
var Pc = /* @__PURE__ */ re({ WebGPURenderer: () => Vc }), Fc = [
	...Oe,
	Qs,
	Gs,
	Ws,
...
N.handleByNamedList(x.WebGPUSystem, Rc), N.handleByNamedList(x.WebGPUPipes, zc), N.handleByNamedList(x.WebGPUPipesAdaptor, Bc), N.add(...Fc, ...Ic, ...Lc);
var Vc = class extends de {
	constructor() {
		let e = {
			name: "webgpu",
			type: O.WEBGPU,
			systems: Rc,
			renderPipes: zc,
			renderPipeAdaptors: Bc
		};
		super(e);
	}
};
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/index.mjs
N.add(Ze, Qe);
//#endregion
//#region src/arena/pet-texture.ts
var Hc = /^#[0-9a-f]{6}$/i, Uc = /* @__PURE__ */ new Set([
	"none",
	"bandana",
	"visor",
	"crown",
...
function Gc(e, t = "#38bdf8") {
	...
	return {
		...
		accessory: Uc.has(n.accessory) ? n.accessory : "none",
		expression: Wc.has(n.expression) ? n.expression : "focused"
	};
}
function Kc(e, t, n) {
	return t ? "win" : e && [
...
var qc = .8, Jc = 3500, Yc = .82, Xc = 2 / 1.8199999999999998;
function Zc(e, t) {
	let n = t - Jc, r = t - 420, i = al((e - n) / Math.max(1, r - n)), a = Yc;
	if (i <= a) return Xc * i;
	let o = Xc * a, s = (1 - i) / .18000000000000005;
...
var tl = .04, nl = .58, rl = 1.15, il = .5399999999999999;
rl * il;
var al = (e) => Math.max(0, Math.min(1, e)), ol = (e) => {
	let t = al(e);
	return t * t * (3 - 2 * t);
}, sl = .34;
function cl(e) {
	let t = ol((e - qc) / .1499999999999999), n = t * sl;
	return {
...
function ll(e, t) {
	return tl + Math.max(0, Math.min(e, 2.15)) * il;
}
function ul(e, t) {
	let n = e - t;
...
function dl(e, t) {
	...
	return n == null ? Infinity : Math.max(n, el(e[0]?.finishMs ?? n));
}
function fl(e, t, n) {
...
function hl(e) {
	let t = e.order.at(-1)?.finishMs ?? Infinity, n = e.order[1]?.finishMs, r = n == null || !e.order[0] ? Infinity : n - e.order[0].finishMs, i = r >= 0 && r <= 180, a = dl(e.order, i), o = e.elapsedMs >= a, s = e.elapsedMs >= t + 320 && o, c = i && n != null ? ul(e.elapsedMs, n) : e.elapsedMs, l = fl(e, s, a), u = e.order[0]?.finishMs ?? Infinity, d = ml(e.order, e.elapsedMs);
	return {
		camera: cl(e.leaderProgress),
		groundRatio: Number.isFinite(u) ? $c(e.elapsedMs, u) : Qc,
		courseStopped: Number.isFinite(u) && e.elapsedMs >= el(u),
		visualElapsedMs: c,
		crossingShown: o,
		crossingShownMs: a,
		celebrationActive: s,
...
var gl = .18, _l = .92;
function vl(e, t) {
	let n = Math.max(240, e), r = Math.max(240, t), i = r > n, a = r < 520 || n < 520, o = r * gl, s = r * _l, c = n * .03, l = n * .91, u = s - o, d = (n <= 640 ? 68 : 88) / 72;
	return {
		width: n,
		height: r,
		portrait: i,
...
function Sl(e, t) {
	return t === 0 ? [...e] : e.map((n, r) => r >= Math.max(9, e.length - 6) ? t === 1 ? xl(n, r % 2 == 0 ? 1 : -1) : t === 2 ? xl(n, +(r % 3 == 0)) : xl(n, r % 2 == 0 ? -1 : 1) : t === 1 || t === 3 ? xl(n, 1) : n);
}
function Cl(e, t) {
...
var wl = (e) => Math.max(0, Math.min(1, e)), Tl = (e) => e <= 0 || e >= 1 ? 0 : Math.sin(e * Math.PI);
function El(e) {
	let t = Math.max(0, e);
	return {
		freeze: +(t < 115),
		converge: t < 760 ? Tl((t - 80) / 680) : .72 + Math.sin(t * .006) * .08,
		launch: Tl((t - 190) / 620),
		celebrate: t < 720 ? 0 : Math.abs(Math.sin((t - 720) * .014)) * wl((t - 720) / 280),
		loserReaction: Tl((t - 120) / 760)
	};
}
//#endregion
//#region src/arena/animation.ts
var Dl = Math.PI * 2, Ol = (e) => Math.max(0, Math.min(1, e)), kl = (e) => 1 - (1 - Ol(e)) ** 3, Al = (e) => Math.sin(Ol(e) * Math.PI), jl = (e = 380) => ({
	x: 0,
	y: 0,
	scaleX: 1,
	scaleY: 1,
...
function Ml(e) {
	...
	if (e.motion === "run") {
		let n = Ol(e.speed ?? t / 3), r = Math.max(-1, Math.min(1, e.acceleration ?? 0)), i = Math.max(235, 410 - t * 48), a = e.elapsedMs / i * Dl + e.lane * .61, o = Math.abs(Math.sin(a)), s = Math.max(0, Math.cos(a));
		return {
			...jl(i),
			...
			frame: Cl(e.elapsedMs + e.lane * 31, i),
			dust: .2 + t * .13 + Math.max(0, r) * .18,
			energy: Math.max(0, r) * .28
		};
	}
	if (e.motion === "surge") {
		let e = Ol(n / 920), r = e < .12 ? e / .12 : 1, a = e < .12 ? 0 : Al((e - .12) / .48), o = kl((e - .6) / .4);
		return {
			...jl(190),
			x: -3.4 * (1 - r) + a * 6.2 * (1 - o),
	...
	if (e.motion === "stumble") {
		let t = Ol(n / 1120), r = Al(t / .16), i = t >= .16 && t < .58 ? Al((t - .16) / .42) : 0, a = t >= .58 ? kl((t - .58) / .42) : 0, o = e.variant >= .34 && e.variant < .67, s = e.variant >= .67, c = s ? i : 0;
		return {
			...jl(480),
	...
	if (e.motion === "jump") {
		let e = Ol(n / 840), r = e < .16 ? Al(e / .16) : 0, i = e >= .16 && e < .76 ? (e - .16) / .6 : 0, a = e >= .76 ? Al((e - .76) / .24) : 0;
		return {
			...jl(285),
			x: i ? kl(i) * 2.3 : 0,
	...
	if (e.motion === "duel") {
		let t = Ol(n / 1050), r = Math.max(0, Math.sin(t * Math.PI * 5));
		return {
			...jl(205),
			x: r * (1.8 + e.variant),
	...
	if (e.motion === "near") {
		let t = Ol(n / 680), r = Al(t / .55), i = Al((t - .5) / .5);
		return {
			...jl(330),
			x: -r * 2.2 + i * 1.2,
			y: -r * (3 + e.variant * 2) + i,
	...
	if (e.motion === "lose") {
		let t = El(n).loserReaction, r = n > 920 ? .34 + Math.sin(n * .008 + e.variant * 9) * .08 : 0;
		return {
			...jl(520),
			x: -t * 3.5 - r * 1.5,
			y: t * 3.2 + r * 2.2,
...
function Ll(e) {
	if (Fl.has(e)) return e;
	let t = Il[e];
	return t && Fl.has(t) ? t : null;
}
function Rl(e) {
	let t = String(e || ""), n = 0;
	for (let e = 0; e < t.length; e++) n = n * 31 + t.charCodeAt(e) | 0;
	return Pl[Math.abs(n) % Pl.length];
}
function zl(e) {
	return Fl.get(Ll(e)) || null;
}
function Bl(e) {
	return zl(e) || Rl(e);
}
...
var $ = (e, t, n, r) => {
	...
	bandana: [...$(6, 17, 8, 9), ...$(17, 19, 10, 11)],
	visor: [...$(7, 17, 4, 5), ...$(17, 19, 6, 6)],
	crown: [
		...$(8, 9, 1, 2),
		...$(12, 13, 1, 2),
		...$(16, 17, 1, 2),
	...
	focused: []
}, Gl = ["none", ...Object.keys(Ul)], Kl = Object.keys(Wl), ql = (e, t) => e.map((e) => ({
	x: e.x1,
	y: e.y,
	w: e.x2 - e.x1 + 1,
	color: t
...
function Yl(e, t = 0) {
	let n = e.species || e.color ? e : Hl(e), r = Bl(n.species), i = n.color || "#2fbf5f", a = n.accent || "#ffffff", o = Jl(Sl(r.px, t), r.palette, i), s = n.accessory ? Ul[n.accessory] : void 0;
	s && o.push(...ql(s, a));
	let c = n.expression ? Wl[n.expression] : void 0;
	return c && o.push(...ql(c, Vl)), {
		width: 24,
		height: 15,
		pose: t,
		runs: o
...
function Zl(e) {
	...
	let n = "";
	for (let [e, r] of t) n += `<path fill="${Xl(e)}" d="${r.join("")}"/>`;
	return n;
}
function Ql(e, t) {
	let n = Hl(e, t), r = Yl(n, 0), i = Yl(n, 2);
	return `<svg class="racer-art racer-px has-frames" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 15" shape-rendering="crispEdges" aria-hidden="true"><g class="px-frame px-frame-a">${Zl(r.runs)}</g><g class="px-frame px-frame-b">${Zl(i.runs)}</g></svg>`;
}
function $l() {
	return Pl.map((e) => e.id);
}
//#endregion
...
function tu(e, t, n) {
	let r = eu(e * 131 + t * 977 + n * 7919);
	return {
		x: (r & 65535) / 65535,
		y: (r >>> 16 & 65535) / 65535,
		length: .35 + (eu(r + 1) & 65535) / 65535 * .65,
		alpha: .3 + (eu(r + 2) & 65535) / 65535 * .7
	};
}
//#endregion
...
function ru(e, t, n, r, i, a, o, s = !1) {
	...
	for (let t = 0; t < 22; t++) {
		let n = tu(Math.floor(a * 100), 404, t), o = n.x * Math.PI * 2, s = 62 + n.y * c * .28, l = r + Math.cos(o) * s, u = i + Math.sin(o) * s;
...
function iu(e) {
	...
	if (n.skid > .05 && (t.moveTo(-8, 19).lineTo(-18 - n.skid * 34, 21).stroke({
		...
		for (let e = 0; e < o; e++) {
			let r = tu(a, Math.floor(i * 17), e), o = 3.2 + r.length * (5.2 + n.dust * 4.4), s = -20 - r.x * (34 + n.dust * 34), c = 15 + r.y * 10 - o * .2;
			t.circle(s, c, o).fill({
		...
		for (let r = 0; r < (e.reducedMotion ? 2 : 6); r++) {
			let e = tu(a, Math.floor(i * 31) + 7, r), o = -16 - e.x * 46, s = 18 + e.y * 7;
...
var au = 3, ou = class {
	app = new nn();
	scenery = new r({ label: "scenery" });
	course = new r({ label: "course" });
	actors = new r({ label: "racers" });
	effects = new r({ label: "effects" });
	overlay = new r({ label: "overlay" });
	#e = new r({ label: "mobile-nameplates" });
	#t = new J({ label: "legacy-feature-set" });
	#n = new pa({
		text: "",
		style: {
			fill: 16777215,
	...
	#r = new J({ label: "background-speed-lines" });
	#i = new J({ label: "winner-focus" });
	#a = new J({ label: "foreground-speed-lines" });
	#o = new J({ label: "photo-finish" });
	#s = new pa({
		text: "",
		style: {
			fill: 16777215,
	...
	async setRacers(e) {
		...
		for (let t of e) {
			let n = new r({ label: `racer-${t.id}` });
			n.eventMode = "none";
			let i = Gc(t.pet, t.color), a = this.#g(i), o = new r({ label: `pet-${i.species}` });
			o.addChild(...a);
			let s = new J({ label: `effects-${t.id}` }), c = new J({ label: `contact-${t.id}` }).ellipse(0, 23, 27, 6).fill({
				color: 0,
				alpha: .42
			}), l = this.#v(t);
			n.addChild(c, s, o), this.#d.set(t.id, {
				root: n,
				art: o,
				frames: a,
				fx: s,
				nameplate: l,
				color: this.#y(i.accent),
				variant: Nl(t.id, e.indexOf(t)),
				motion: "idle",
				motionStartedMs: 0,
				finishedAtMs: null,
				effectKey: ""
			}), this.actors.addChild(n), this.#e.addChild(l);
		}
	}
	render(e) {
		this.#f = e;
		...
		i !== this.#h && (this.#h = i, nu(this.#o, this.#s, e, this.#l, t)), this.#i.clear();
		let a = 0, o = null;
		for (let n of e.racers) {
			let r = this.#d.get(n.id);
			if (!r) continue;
			let i = e.finish?.celebrationActive === !0, s = i && n.finished && n.id === e.winnerId, c = s ? "win" : i && n.finished ? "lose" : n.exiting ? "run" : n.finished ? "idle" : Kc(n.reaction, !1, e.state);
			...
			let l = Ml({
				...
				reducedMotion: t
			}), u = e.finish?.camera.mix ?? 0, d = n.displayProgress ?? n.progress, f = +!!s, p = f ? this.#l.width * .5 : bl(this.#l, d, e.finish?.camera), m = f ? this.#l.height * .5 : yl(this.#l, n.lane, this.#u.length, u);
			...
			_ !== r.effectKey && (r.effectKey = _, iu({
				graphics: r.fx,
				pose: l,
				elapsedMs: e.elapsedMs,
				variant: r.variant,
		...
		o && ru(this.#i, this.#l.width, this.#l.height, o.x, o.y, o.intensity, e.elapsedMs, t);
	...
	resize() {
		this.#c && (this.app.resize(), this.#l = vl(this.app.screen.width, this.app.screen.height), this.app.canvas.dataset.actorWidth = String(Math.round(this.#l.actorScale * 72)), this.#f && this.render(this.#f));
	}
	destroy() {
	...
	#_(e) {
		let t = new J();
		for (let n of e.runs) t.rect((n.x - e.width / 2) * au, (n.y - e.height / 2) * au, n.w * au, au).fill(this.#y(n.color));
		return t;
	}
	#v(e) {
		let t = new r({ label: `name-${e.id}` }), n = new pa({
			text: e.name,
			style: {
				fill: 16777215,
		...
		n.anchor.set(0, .5);
		let i = 2.5, a = n.width + i * 2 + 9, o = new J().roundRect(-a / 2 - 3, -7, a + 6, 14, 4).fill({
			color: 396052,
			alpha: .42
		}), s = new J().circle(-a / 2 + i, 0, i).fill({
			color: this.#y(e.color),
			alpha: 1
		});
		return n.position.set(-a / 2 + i * 2 + 5, 0), t.addChild(o, s, n), t.eventMode = "none", t.alpha = .82, t.visible = !1, t;
	}
	#y(e) {
...
var cu = [
	...
	"near",
	"surge"
], lu = 500, uu = 40, du = 3.1, fu = [
	300,
	550,
	900
];
function pu(e) {
	let t = Math.max(1, (Math.max(1, e) - 1) / du);
	return fu.some((e) => Math.abs(t - e) < 1) || t <= 900 ? lu : Math.min(2e3, Math.round(lu * t / 550));
}
function mu(e, t, n) {
...
function gu(e, t) {
	...
	let r = pu(e.samples.length), i = n - r;
	if (e.elapsedMs <= i || e.elapsedMs >= n) return t;
	let a = Math.max(0, Math.min(e.samples.length - 1, Math.floor(i / uu))), o = Math.max(0, Math.min(.999999, e.samples[a] ?? t)), s = Math.max(0, Math.min(1, (e.elapsedMs - i) / r));
	return o + (1 - o) * s;
}
function _u(e) {
	let t = Math.max(0, Math.min(e.samples.length - 1, e.lo)), n = Math.max(t, Math.min(e.samples.length - 1, e.hi)), r = Math.max(0, Math.min(1, e.mix)), i = e.samples[t] ?? 0, a = e.samples[n] ?? i, o = e.samples[Math.max(0, t - 1)] ?? i, s = gu(e, e.elapsedMs <= 0 ? 0 : i + (a - i) * r), c = Math.max(0, Math.min(1, (a - i) * 180)), l = Math.max(-1, Math.min(1, (a - i - (i - o)) * 500)), u = e.officialFinishMs == null ? !!e.finished || s >= 1 : e.elapsedMs >= e.officialFinishMs, d = s, f = u && e.officialFinishMs != null && e.elapsedMs < e.officialFinishMs + 360, p = u ? null : hu(e.timeline, e.lane, e.elapsedMs);
	return {
		id: e.id,
		lane: e.lane,
		progress: s,
...
var vu = .46, yu = .38, bu = .07, xu = .26, Su = .85, Cu = .82, wu = .175, Tu = (e) => {
	let t = e <= 0 ? 0 : e >= 1 ? 1 : e;
	return t * t * (3 - 2 * t);
};
function Eu(e) {
	return e >= .07 ? 1 : Tu(e / bu);
}
function Du(e) {
	return e <= 0 ? 0 : e >= 900 ? 1 : Tu(e / 900);
}
function Ou(e) {
	return e >= .26 ? 1 : Tu(e / xu);
}
function ku(e) {
	let t = (e, t) => e * Math.tanh(Math.max(0, t) / e), n = Math.max(0, Math.min(1, (e - Cu) / .18000000000000005)), r = Su + -.6699999999999999 * (n * n * (3 - 2 * n));
	return {
		ahead: t(vu, (1 - e) * r),
		behind: t(yu, e * .9)
	};
...
function ju(e, t = 0) {
	...
	return e < n ? Tu(e / n) : e > 1 - n ? Tu((1 - e) / n) : 1;
}
function Mu(e, t, n) {
	let r = Au((t >>> 0 ^ 1374496513) >>> 0), i = Array.from({ length: n }, () => []), a = e.samples[0];
	if (!a) return i;
	let o = (t) => {
		let r = 0;
...
function Pu(e, t) {
	...
	let i = Au((t >>> 0 ^ 2654435769) >>> 0), a = Array.from({ length: n }, () => ({
		a1: .6 + i() * .55,
		f1: 1.3 + i() * 1.6,
		p1: i() * Math.PI * 2,
		a2: .22 + i() * .3,
		...
		p2: i() * Math.PI * 2,
		amp: .45 + i() * 1.5
	})), o = Mu(e, t, n), s = Array.from({ length: n }, () => new Float32Array(r + 1)), c = [], l = /* @__PURE__ */ new Set(), u = new Map(e.order.map((e) => [e.index, e.finishMs]));
	for (let t = 0; t < n; t++) {
		...
		for (let e = 0; e <= r; e++) {
			...
			for (let n of d) {
				p += n.power * ju((r - n.start) / n.width, n.hold);
			...
			let m = Eu(r) * Du(f - e * 40) * Ou(r), h = (u * n.amp * wu * a + p) * m, { ahead: g, behind: _ } = ku(r), v = h >= 0 ? g : _, y = v > 1e-6 ? v * Math.tanh(h / v) : 0, b = r * Eu(r) + y;
...
function Lu(e) {
	...
	for (let r of e.order) {
		let i = Math.max(1e-6, t[r.index] ?? 1e-4), a = Fu(r.place, e.order.length), o = a / i;
		n[r.index] = {
			finishMs: r.finishMs,
			place: r.place,
			crossSpeed: i,
...
function Vu(e, t, n, r) {
	let i = Bu(t, n, r);
	if (e.phase = i, e.displayProgress = zu(e.progress, t, n), e.exiting = i === "crossing" || i === "coasting", e.exiting && n) {
		let r = t - n.finishMs;
		e.speed = Math.max(0, Math.min(1, n.crossSpeed * Ru(r) * 40 * 180));
	}
	return e;
}
//#endregion
...
//#endregion
export { Gl as ACCESSORY_KEYS, Kl as EXPRESSION_KEYS, _l as LANE_BAND_BOTTOM, gl as LANE_BAND_TOP, yu as MAX_DROP, vu as MAX_LEAD, ku as allowance, ju as arcShape, su as backgroundMotion, $l as characterIds, Ql as characterSvg, Du as closingEase, zu as coastProgress, Yl as composeCharacter, Uu as createArenaRenderer, hl as createFinishPresentation, mu as createReactionTimeline, Nu as crossingSpeeds, Pu as dramatize, Zc as finishArrival, Bu as finishPhase, el as finishSettledMs, Lu as finishTrajectories, Eu as launchEase, Hl as normalizeCharacter, Ou as openEase, Mu as planArcs, Vu as presentFinish, _u as presentationRacerFrame, ll as presentationScreenRatio, hu as reactionAt, Zl as runsToPaths, Fu as settleOffset, Jl as silhouetteRuns };
