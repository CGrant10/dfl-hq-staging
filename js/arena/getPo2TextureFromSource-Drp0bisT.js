import { $ as e, B as t, C as n, D as r, G as i, H as a, M as o, N as s, R as c, T as l, W as u, _ as d, at as f, b as p, j as m, ot as h, x as g, y as _ } from "./Geometry-D1neCpWU.js";
import { r as v } from "./canvasUtils-DlqG_Aub.js";
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/mask/utils/addMaskBounds.mjs
var y = new t();
function b(e, t, n) {
	let r = y;
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/mask/utils/addMaskLocalBounds.mjs
function x(e, t, n) {
	let i = o.get();
	e.measurable = !0;
	let a = s.get().identity(), c = S(e, n, a);
	r(e, i, c), e.measurable = !1, t.addBoundsMask(i), s.return(a), o.return(i);
}
function S(e, t, n) {
	return e ? (e !== t && (S(e.parent, t, n), e.updateLocalTransform(), n.append(e.localTransform)), n) : (c("Mask bounds, renderable is not inside the root container"), n);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/mask/alpha/AlphaMask.mjs
var C = class {
	constructor(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/mask/color/ColorMask.mjs
var w = class {
	constructor(e) {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/mask/stencil/StencilMask.mjs
var T = class {
	constructor(e) {
...
T.extension = f.MaskEffect;
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/utils/browser/detectVideoAlphaMode.mjs
var E;
async function D() {
	return E ??= (async () => {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/renderers/shared/texture/sources/VideoSource.mjs
var O = class e extends i {
	...
	updateFrame() {
		if (!this.destroyed) {
			if (this._updateFPS) {
				let e = d.shared.elapsedMS * this.resource.playbackRate;
	...
	_configureAutoUpdate() {
		this._autoUpdate && this._isSourcePlaying() ? !this._updateFPS && this.resource.requestVideoFrameCallback ? (this._isConnectedToTicker && (d.shared.remove(this.updateFrame, this), this._isConnectedToTicker = !1, this._msToNextUpdate = 0), this._videoFrameRequestCallbackHandle === null && (this._videoFrameRequestCallbackHandle = this.resource.requestVideoFrameCallback(this._videoFrameRequestCallback))) : (this._videoFrameRequestCallbackHandle !== null && (this.resource.cancelVideoFrameCallback(this._videoFrameRequestCallbackHandle), this._videoFrameRequestCallbackHandle = null), this._isConnectedToTicker || (d.shared.add(this.updateFrame, this), this._isConnectedToTicker = !0, this._msToNextUpdate = 0)) : (this._videoFrameRequestCallbackHandle !== null && (this.resource.cancelVideoFrameCallback(this._videoFrameRequestCallbackHandle), this._videoFrameRequestCallbackHandle = null), this._isConnectedToTicker && (d.shared.remove(this.updateFrame, this), this._isConnectedToTicker = !1, this._msToNextUpdate = 0));
	}
	static test(e) {
		return globalThis.HTMLVideoElement && e instanceof HTMLVideoElement;
	}
};
O.extension = f.TextureSource, O.defaultOptions = {
	...i.defaultOptions,
	autoLoad: !0,
	autoPlay: !0,
	updateFPS: 0,
...
var k = O, A = (e, t, n = !1) => (Array.isArray(e) || (e = [e]), t ? e.map((e) => typeof e == "string" || n ? t(e) : e) : e), j = new class {
	...
	get(e) {
		...
		return t || c(`[Assets] Asset id ${e} was not found in the Cache`), t;
	}
	set(e, t) {
		let n = A(e), r;
		...
		n.forEach((e) => {
			...
			let n = r ? r[e] : t;
			this._cache.has(e) && this._cache.get(e) !== n && c("[Cache] already has key:", e), this._cache.set(e, i.get(e));
		});
	}
	remove(e) {
		if (!this._cacheMap.has(e)) {
			c(`[Assets] Asset id ${e} was not found in the Cache`);
			return;
		}
...
h.handleByList(f.TextureSource, M);
function N(e = {}) {
...
function P(e = {}, t = !1) {
	...
	if (!t && j.has(r)) return j.get(r);
	let o = new a({ source: N(i) });
	return o.on("destroy", () => {
		j.has(r) && j.remove(r);
	}), t || j.set(r, o), o;
}
function F(e, t = !1) {
	return typeof e == "string" ? j.get(e) : e instanceof i ? new a({ source: e }) : P(e, t);
}
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/rendering/init.mjs
a.from = F, i.from = N, h.add(C, w, T, k, v, _, u);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/assets/loader/parsers/LoaderParser.mjs
var I = /* @__PURE__ */ ((e) => (e[e.Low = 0] = "Low", e[e.Normal = 1] = "Normal", e[e.High = 2] = "High", e))(I || {});
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/utils/path.mjs
function L(e) {
...
var H = {
	...
	toAbsolute(e, t, n) {
		...
		let r = R(this.toPosix(t ?? p.get().getBaseUrl())), i = R(this.toPosix(n ?? this.rootname(r)));
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/assets/utils/createStringVariations.mjs
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/assets/utils/isSingleItem.mjs
var G = (e) => !Array.isArray(e), K = class {
	...
	addManifest(e) {
		this._manifest && c("[Resolver] Manifest already exists, this will be overwritten"), this._manifest = e, e.bundles.forEach((e) => {
	...
	add(e) {
		...
		let n = (e) => {
			this.hasKey(e) && c(`[Resolver] already has key: ${e} overwriting`);
		};
		A(t).forEach((e) => {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/assets/utils/copySearchParams.mjs
var J = (e, t) => {
	let n = t.split("?")[1];
	return n && (e += `?${n}`), e;
}, Y = class t {
	constructor(e, t) {
		this.linkedSheets = [];
		let n = e;
		e?.source instanceof i && (n = {
			texture: e,
			data: t
		});
		let { texture: r, data: o, cachePrefix: s = "" } = n;
		this.cachePrefix = s, this._texture = r instanceof a ? r : null, this.textureSource = r.source, this.textures = {}, this.animations = {}, this.data = o;
	...
	_processFrames(n, r = !1) {
		let i = n, o = r ? Infinity : t.BATCH_SIZE;
		for (; i - n < o && i < this._frameKeys.length;) {
			let t = this._frameKeys[i], n = this._frames[t], r = n.frame;
			if (r) {
				let i = null, o = null, s = n.trimmed !== !1 && n.sourceSize ? n.sourceSize : n.frame, c = new e(0, 0, Math.floor(s.w) / this.resolution, Math.floor(s.h) / this.resolution);
				i = n.rotated ? new e(Math.floor(r.x) / this.resolution, Math.floor(r.y) / this.resolution, Math.floor(r.h) / this.resolution, Math.floor(r.w) / this.resolution) : new e(Math.floor(r.x) / this.resolution, Math.floor(r.y) / this.resolution, Math.floor(r.w) / this.resolution, Math.floor(r.h) / this.resolution), n.trimmed !== !1 && n.spriteSourceSize && (o = new e(Math.floor(n.spriteSourceSize.x) / this.resolution, Math.floor(n.spriteSourceSize.y) / this.resolution, Math.floor(r.w) / this.resolution, Math.floor(r.h) / this.resolution)), this.textures[t] = new a({
...
var $ = {
	...
	loader: {
		...
		async parse(e, t, n) {
			let { texture: r, imageFilename: i, textureOptions: o, cachePrefix: s } = t?.data ?? {}, c = H.dirname(t.src);
			c && c.lastIndexOf("/") !== c.length - 1 && (c += "/");
			let l;
			if (r instanceof a) l = r;
			else {
...
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/spritesheet/init.mjs
h.add($);
//#endregion
//#region node_modules/.pnpm/pixi.js@8.20.0/node_modules/pixi.js/lib/scene/text/utils/getPo2TextureFromSource.mjs
var ee = new t();
function te(e, t, n, r, i = !1) {
	let a = ee;
	a.minX = 0, a.minY = 0, a.maxX = e.width / r | 0, a.maxY = e.height / r | 0;
	let o = l.getOptimalTexture(a.width, a.height, r, !1, i);
...
//# sourceMappingURL=getPo2TextureFromSource-Drp0bisT.js.map